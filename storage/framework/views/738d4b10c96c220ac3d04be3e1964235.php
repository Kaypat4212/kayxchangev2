<?php $__env->startSection('content'); ?>
    ...
    <nav class="kx-hp-nav navbar navbar-expand-lg" id="kxHomeNav">
        <div class="container">
            <a class="kx-brand" href="<?php if(auth()->guard()->check()): ?> <?php echo e(url('/dashboard')); ?> <?php else: ?> <?php echo e(url('/')); ?> <?php endif; ?>">
            ...
            <div class="collapse navbar-collapse" id="kxHomeCollapse">
                <ul class="navbar-nav me-auto mb-2 mb-lg-0 gap-1">
                    ...
                    <li class="nav-item"><a class="kx-hp-link <?php if(request()->is('dashboard')): ?> kx-act <?php endif; ?>" href="<?php echo e(url('/dashboard')); ?>"><i class="bi bi-grid-1x2-fill"></i>Dashboard</a></li>
                    <li class="nav-item"><a class="kx-hp-link <?php if(request()->is('rate')): ?> kx-act <?php endif; ?>" href="<?php echo e(url('/rate')); ?>"><i class="bi bi-graph-up-arrow"></i>Rates</a></li>
                    <li class="nav-item"><a class="kx-hp-link <?php if(request()->is('buy*')): ?> kx-act <?php endif; ?>" href="<?php echo e(url('/buy')); ?>"><i class="bi bi-arrow-down-circle-fill"></i>Buy</a></li>
                    <li class="nav-item"><a class="kx-hp-link <?php if(request()->is('sell*')): ?> kx-act <?php endif; ?>" href="<?php echo e(url('/sell')); ?>"><i class="bi bi-arrow-up-circle-fill"></i>Sell</a></li>
                    <?php else: ?>
                    <li class="nav-item"><a class="kx-hp-link kx-act" href="<?php echo e(url('/')); ?>"><i class="bi bi-house-fill"></i>Home</a></li>
                    <li class="nav-item"><a class="kx-hp-link" href="<?php echo e(url('/rate')); ?>"><i class="bi bi-graph-up-arrow"></i>Rates</a></li>
                    <li class="nav-item"><a class="kx-hp-link" href="<?php echo e(url('/blog')); ?>"><i class="bi bi-newspaper"></i>Blog</a></li>
                    <li class="nav-item"><a class="kx-hp-link" href="<?php echo e(url('/faqs')); ?>"><i class="bi bi-question-circle-fill"></i>FAQs</a></li>
                    <li class="nav-item"><a class="kx-hp-link" href="<?php echo e(url('/about')); ?>"><i class="bi bi-info-circle-fill"></i>About</a></li>
                    <?php endif; ?>
                </ul>
                <div class="d-flex align-items-center kx-hp-nav-actions gap-2">
                    ...
                    <?php else: ?>
                    <a class="kx-hp-btn-in" href="<?php echo e(route('login')); ?>"><i class="bi bi-box-arrow-in-right"></i>Login</a>
                    <a class="kx-hp-btn-reg" href="<?php echo e(route('register')); ?>"><i class="bi bi-rocket-takeoff-fill"></i>Get Started</a>
                    <?php endif; ?>
            ...
            <div class="row align-items-center">
                ...
                <div class="col-lg-6">
                    ...
                    <div class="kx-h-trust" data-aos="fade-up" data-aos-delay="380">
                        ...
                        <a href="<?php echo e(url('/rate')); ?>" class="kx-h-tbadge">
                ...
                <div class="col-lg-6 kx-h-visual" data-aos="zoom-in" data-aos-delay="200">
                    <div class="kx-h-card-wrap">
                        <div class="kx-h-mockup">
                            <img src="<?php echo e(asset('Assests/images/kay-xchange-logo-mockup.png')); ?>" alt="KayXchange Platform">
                        </div>
        ...
        <div class="container">
            <div class="row align-items-center g-5">
                <div class="col-lg-6" data-aos="fade-right">
                    ...
                    <h2 class="kx-sec-h"><?php echo e($siteContent['about_heading'] ?? 'About KayXchange'); ?></h2>
                    <p class="kx-sec-sub mb-4"><?php echo e($siteContent['about_subheading'] ?? 'Nigeria\'s most trusted platform.'); ?></p>
                    <p style="font-size:0.88rem;color:rgba(255,255,255,0.48);line-height:1.8;margin-bottom:28px"><?php echo e($siteContent['about_description'] ?? 'Our platform provides a seamless, secure experience for clients exchanging digital assets.'); ?></p>
                    ...
                    <a href="<?php echo e(url('/about')); ?>" class="kx-about-btn mt-4 d-inline-flex">
                        ...
                        <div id="kxAboutCarousel" class="carousel slide" data-bs-ride="carousel">
                            <div class="carousel-inner">
                                <div class="carousel-item active">
                                    <img class="d-block w-100" src="<?php echo e(asset('Assests/images/carousel/ourratedeybuga.jpeg')); ?>" alt="Our Rates">
                                </div>
                                <div class="carousel-item">
                                    <img class="d-block w-100" src="<?php echo e(asset('Assests/images/carousel/Youdontneedtogofar.jpeg')); ?>" alt="Trade Easy">
                                </div>
                                <div class="carousel-item">
                                    <img class="d-block w-100" src="<?php echo e(asset('Assests/images/carousel/neednairaforexchange.jpeg')); ?>" alt="Need Naira">
                                </div>
                            </div>
        ...
        <div class="container">
            <div class="d-flex justify-content-center align-items-stretch gap-0 flex-wrap">
                <div class="kx-stat-item">
                    <div class="kx-stat-num" data-purecounter-start="0" data-purecounter-end="<?php echo e($siteContent['stat_clients'] ?? 3000); ?>" data-purecounter-duration="1" class="purecounter kx-stat-num"><?php echo e($siteContent['stat_clients'] ?? '3000'); ?></div>
                    <div class="kx-stat-lbl">Happy Traders</div>
                </div>
                <div class="kx-stat-div d-none d-sm-block"></div>
                <div class="kx-stat-item">
                    <div class="kx-stat-num" data-purecounter-start="0" data-purecounter-end="<?php echo e($siteContent['stat_trades'] ?? 90000); ?>" data-purecounter-duration="1" class="purecounter kx-stat-num"><?php echo e($siteContent['stat_trades'] ?? '90,000'); ?></div>
    ...
    <section class="kx-sec kx-sec-alt" id="why">
        <div class="container">
            <div class="text-center mb-5" data-aos="fade-up">
                ...
                <h2 class="kx-sec-h"><?php echo e($siteContent['why_heading'] ?? 'Why People Choose Crypto'); ?></h2>
            ...
            <div class="row g-4">
                <div class="col-md-4" data-aos="fade-up" data-aos-delay="100">
                    <div class="kx-why-card">
                        ...
                        <h3 class="kx-why-t"><?php echo e($siteContent['why_card1_title'] ?? 'Easy Mode of Payment'); ?></h3>
                        <p class="kx-why-d"><?php echo e($siteContent['why_card1_desc'] ?? 'Send and receive money globally with ease.'); ?></p>
                    </div>
                </div>
                <div class="col-md-4" data-aos="fade-up" data-aos-delay="200">
                    <div class="kx-why-card">
                        <div class="kx-why-icon kx-why-i2"><i class="bi bi-bank2"></i></div>
                        <h3 class="kx-why-t"><?php echo e($siteContent['why_card2_title'] ?? 'Financial Freedom'); ?></h3>
                        <p class="kx-why-d"><?php echo e($siteContent['why_card2_desc'] ?? 'Full transparency and privacy over your money.'); ?></p>
                    </div>
                </div>
                <div class="col-md-4" data-aos="fade-up" data-aos-delay="300">
                    <div class="kx-why-card">
                        <div class="kx-why-icon kx-why-i3"><i class="bi bi-graph-up-arrow"></i></div>
                        <h3 class="kx-why-t"><?php echo e($siteContent['why_card3_title'] ?? 'Investment'); ?></h3>
                        <p class="kx-why-d"><?php echo e($siteContent['why_card3_desc'] ?? 'Digital Gold — a popular store of wealth for investors.'); ?></p>
                    </div>
                </div>
            </div>
        </div>
    ...
    <section class="kx-sec kx-sec-dark" id="how">
        <div class="container">
            ...
            <div class="text-center mt-5" data-aos="fade-up" data-aos-delay="200">
                <?php if(auth()->guard()->check()): ?>
                <a href="<?php echo e(url('/sell')); ?>" class="kx-h-cta1" style="display:inline-flex"><i class="bi bi-arrow-up-circle-fill"></i>Sell Crypto Now</a>
                <?php else: ?>
                <a href="<?php echo e(route('register')); ?>" class="kx-h-cta1" style="display:inline-flex"><i class="bi bi-rocket-takeoff-fill"></i>Get Started Free</a>
                <?php endif; ?>
            </div>
        </div>
    </section>
            ...
            <div class="row g-4">
                <div class="col-lg-4 col-md-6" data-aos="fade-up" data-aos-delay="100">
                    <div class="kx-trade-card kx-trade-btc">
                        <div class="kx-trade-icon"><img src="<?php echo e(asset('Assests/crypto-icons/btc.svg')); ?>" alt="Bitcoin"></div>
                ...
                <div class="col-lg-4 col-md-6" data-aos="fade-up" data-aos-delay="200">
                    <div class="kx-trade-card kx-trade-eth">
                        <div class="kx-trade-icon"><img src="<?php echo e(asset('Assests/crypto-icons/eth.svg')); ?>" alt="Ethereum"></div>
            ...
            <div class="row g-4">
                <div class="col-md-4" data-aos="fade-up" data-aos-delay="100">
                    <div class="kx-review-card">
                        ...
                        <div class="d-flex align-items-center gap-12" style="gap:12px">
                            <img src="<?php echo e(asset('Assests/images/image1.png')); ?>" class="kx-review-avatar" alt="Amarachi">
                ...
                <div class="col-md-4" data-aos="fade-up" data-aos-delay="200">
                    <div class="kx-review-card">
                        ...
                        <div class="d-flex align-items-center" style="gap:12px">
                            <img src="<?php echo e(asset('Assests/images/image2.png')); ?>" class="kx-review-avatar" alt="Ade Simi">
                ...
                <div class="col-md-4" data-aos="fade-up" data-aos-delay="300">
                    <div class="kx-review-card">
                        ...
                        <div class="d-flex align-items-center" style="gap:12px">
                            <img src="<?php echo e(asset('Assests/images/image3.png')); ?>" class="kx-review-avatar" alt="Oliseh">
    ...
    <section class="kx-sec kx-sec-alt" id="blog">
        <div class="container">
            ...
            <div class="row g-4">
                ...
                <div class="col-md-6 col-lg-3" data-aos="fade-up" data-aos-delay="<?php echo e(($i+1)*80); ?>">
                    <div class="kx-blog-card">
                        <span class="kx-blog-date"><i class="bi bi-calendar3 me-1"></i><?php echo e($post['date']); ?></span>
                        <h3 class="kx-blog-title"><?php echo e($post['title']); ?></h3>
                        <a href="<?php echo e($post['url']); ?>" class="kx-blog-link">Read More <i class="bi bi-arrow-right"></i></a>
                    </div>
                </div>
        ...
        <div class="container kx-nl-inner">
            <div class="row align-items-center g-4">
                <div class="col-lg-7" data-aos="fade-right">
                    ...
                    <h2><?php echo e($siteContent['newsletter_title'] ?? 'Stay Ahead of the Market'); ?></h2>
                    <p class="kx-nl-sub"><?php echo e($siteContent['newsletter_subtitle'] ?? 'Get weekly market insights, trading tips, and exclusive rate notifications.'); ?></p>
        ...
        <div class="container">
            <div class="row g-5">
                ...
                <div class="col-lg-4 col-md-12">
                    <a href="<?php echo e(url('/')); ?>" class="kx-footer-logo">
                        <img src="<?php echo e(asset('Assests/favicon.png')); ?>" alt="KayXchange">
                        <span>Kay<b>Xchange</b></span>
                    </a>
                    <p class="kx-footer-desc"><?php echo e($siteContent['footer_tagline'] ?? 'Your trusted platform for seamless cryptocurrency trading. Fast, secure, and competitive NGN rates.'); ?></p>
                ...
                <div class="col-lg-2 col-6">
                    ...
                    <ul class="kx-footer-links">
                        <li><a href="<?php echo e(url('/dashboard')); ?>"><i class="bi bi-chevron-right"></i>Dashboard</a></li>
                        <li><a href="<?php echo e(url('/buy')); ?>"><i class="bi bi-chevron-right"></i>Buy Crypto</a></li>
                        <li><a href="<?php echo e(url('/sell')); ?>"><i class="bi bi-chevron-right"></i>Sell Crypto</a></li>
                        <li><a href="<?php echo e(url('/rate')); ?>"><i class="bi bi-chevron-right"></i>Live Rates</a></li>
                        <li><a href="<?php echo e(url('/referrals')); ?>"><i class="bi bi-chevron-right"></i>Referrals</a></li>
                    </ul>
                </div>
                ...
                <div class="col-lg-2 col-6">
                    ...
                    <ul class="kx-footer-links">
                        <li><a href="<?php echo e(url('/about')); ?>"><i class="bi bi-chevron-right"></i>About Us</a></li>
                        <li><a href="<?php echo e(url('/faqs')); ?>"><i class="bi bi-chevron-right"></i>FAQs</a></li>
                        <li><a href="<?php echo e(url('/blog')); ?>"><i class="bi bi-chevron-right"></i>Blog</a></li>
                        <li><a href="<?php echo e(url('/privacy')); ?>"><i class="bi bi-chevron-right"></i>Privacy Policy</a></li>
                        <li><a href="<?php echo e(url('/terms')); ?>"><i class="bi bi-chevron-right"></i>Terms of Service</a></li>
                    </ul>
                </div>
                    ...
                    <div class="kx-footer-contact">
                        <div class="kx-footer-ci">
                            ...
                            <div>
                                ...
                                <div class="kx-footer-ci-v"><a href="mailto:<?php echo e($siteContent['contact_email'] ?? 'support@kayxchange.net'); ?>"><?php echo e($siteContent['contact_email'] ?? 'support@kayxchange.net'); ?></a></div>
                            </div>
                        </div>
                        <div class="kx-footer-ci">
                            ...
                            <div>
                                ...
                                <div class="kx-footer-ci-v"><a href="tel:+2349016740523"><?php echo e($siteContent['contact_phone'] ?? '+234 901 674 0523'); ?></a></div>
                            </div>
                        </div>
                        <div class="kx-footer-ci">
                            ...
                            <div>
                                ...
                                <div class="kx-footer-ci-v"><?php echo e($siteContent['contact_location'] ?? 'Nigeria'); ?> &bull; <span style="color:#00cc00;">Available 24/7</span></div>
                            </div>
                        </div>
                    </div>
                </div>
...
<?php echo $__env->make('layouts.header', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\kayxchangev2\resources\views\home.blade.php ENDPATH**/ ?>