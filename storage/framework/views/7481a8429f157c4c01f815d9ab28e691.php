...
<div class="kx-welcome d-flex align-items-center justify-content-between flex-wrap gap-3">
    ...
    <div class="d-flex align-items-center gap-2">
        <?php if($settings['ai_bot_enabled'] === '1'): ?>
        ...
        <?php endif; ?>
        <a href="<?php echo e(route('admin.telegram.index')); ?>" class="kx-btn kx-btn-muted" style="padding:7px 14px;font-size:0.8rem;">
            ← Telegram Settings
        </a>
    </div>
</div>
...
<div class="container-fluid px-3 pb-4">
    ...
    <?php endif; ?>
    <?php if($errors->any()): ?>
        <div class="alert-danger">⚠️ <?php echo e($errors->first()); ?></div>
    <?php endif; ?>

    <div class="row g-3">
        
        <div class="col-lg-7">
            <form method="POST" action="<?php echo e(route('admin.telegram.ai-config.update')); ?>">
                <?php echo csrf_field(); ?>
                        ...
                        <div class="d-flex align-items-center gap-3">
                            <label class="kx-toggle">
                                <input type="checkbox" name="ai_bot_enabled" value="1"
                                    <?php echo e($settings['ai_bot_enabled'] === '1' ? 'checked' : ''); ?>>
                        ...
                        <div class="d-flex align-items-center gap-3">
                            <label class="kx-toggle">
                                <input type="checkbox" name="ai_bot_trade_suggestions" value="1"
                                    <?php echo e($settings['ai_bot_trade_suggestions'] === '1' ? 'checked' : ''); ?>>
                                <span class="kx-toggle-slider"></span>
                            </label>
                            <div>
                    ...
                    <div class="kx-panel-body">
                        <div class="kx-form-group">
                            ...
                            <textarea name="ai_bot_welcome_message" class="kx-form-control" rows="4"
                                placeholder="Leave blank to use default welcome message..."><?php echo e($settings['ai_bot_welcome_message']); ?></textarea>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="kx-panel-body">
                        <div class="kx-form-group">
                            ...
                            <textarea name="ai_bot_system_prompt" class="kx-form-control" rows="6"
                                placeholder="Leave blank to use the built-in KayXchange default prompt..."><?php echo e($settings['ai_bot_system_prompt']); ?></textarea>
                    ...
                    <div class="kx-panel-body">
                        <div class="row g-3">
                                ...
                                <div class="kx-form-group mb-0">
                                    ...
                                    <select name="ai_bot_model" class="kx-form-control">
                                        <?php $__currentLoopData = [
                                            ...
                                            <option value="<?php echo e($value); ?>" <?php echo e($settings['ai_bot_model'] === $value ? 'selected' : ''); ?>>
                                                <?php echo e($label); ?>
                            ...
                            <div class="col-md-6">
                                <div class="kx-form-group mb-0">
                                    <label class="kx-form-label">
                                        Max Tokens — <span id="tokenVal"><?php echo e($settings['ai_bot_max_tokens']); ?></span>
                                    </label>
                                    <input type="range" name="ai_bot_max_tokens" class="kx-range"
                                        min="100" max="2048" step="50"
                                        value="<?php echo e($settings['ai_bot_max_tokens']); ?>"
                            ...
                            <div class="col-md-6">
                                <div class="kx-form-group mb-0">
                                    <label class="kx-form-label">
                                        Temperature — <span id="tempVal"><?php echo e($settings['ai_bot_temperature']); ?></span>
                                    </label>
                                    <input type="range" name="ai_bot_temperature" class="kx-range"
                                        min="0" max="1.5" step="0.1"
                                        value="<?php echo e($settings['ai_bot_temperature']); ?>"
            ...
            <div class="kx-panel">
                ...
                <div class="kx-panel-body">
                    ...
                    <div class="d-flex flex-wrap gap-2">
                        <?php $__currentLoopData = ["What is today's BTC rate?", "Should I sell USDT now?", "How do I buy crypto?", "What's my balance?"]; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $q): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <button class="kx-btn kx-btn-muted" style="font-size:0.75rem;padding:5px 10px;"
                                onclick="quickTest('<?php echo e($q); ?>')"><?php echo e($q); ?></button>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                    </div>
                </div>
            </div>
...
async function sendTest() {
    ...
    try {
        const resp = await fetch('<?php echo e(route("admin.telegram.ai-config.test")); ?>', {
            method: 'POST',
            headers: {
...
<?php echo $__env->make('adminnavlayout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\kayxchangev2\resources\views\admin\ai-bot-config.blade.php ENDPATH**/ ?>