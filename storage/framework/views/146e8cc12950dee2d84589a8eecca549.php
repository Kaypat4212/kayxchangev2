    ...
    <div class="install-container">
        <div class="install-card">
            ...
            <div class="install-body">
                ...
                <form method="POST" action="<?php echo e(route('install.database.store')); ?>" id="databaseForm">
                    <?php echo csrf_field(); ?>
                    ...
                    <div class="form-floating">
                        <input type="text" class="form-control" id="db_name" name="db_name" 
                               value="<?php echo e(old('db_name')); ?>" required>
                    ...
                    <div class="form-floating">
                        <input type="text" class="form-control" id="db_username" name="db_username" 
                               value="<?php echo e(old('db_username')); ?>" required>
                    ...
                    <div class="d-flex justify-content-between mt-4">
                        <a href="<?php echo e(route('install.requirements')); ?>" class="btn btn-outline-secondary">
...
</html><?php /**PATH C:\xampp\htdocs\kayxchangev2\resources\views\install\database.blade.php ENDPATH**/ ?>