...
<div style="display:none;max-height:0;overflow:hidden;mso-hide:all;font-size:1px;line-height:1px;color:#0d1117;">
  Welcome to <?php echo e(config('app.name')); ?>, <?php echo e($user->name); ?>! Your account is ready. &nbsp;&zwnj;&nbsp;&zwnj;&nbsp;&zwnj;
</div>
...
<table width="600" cellpadding="0" cellspacing="0" role="presentation" style="max-width:600px;width:100%;">
  ...
  <tr>
    <td style="padding:0 0 12px;text-align:center;">
      <a href="<?php echo e(url('/')); ?>" style="text-decoration:none;">
        <img src="<?php echo e(url('/Assests/Logo.svg')); ?>" width="140" alt="<?php echo e(config('app.name')); ?>"
  ...
  <tr>
    <td style="background:linear-gradient(135deg,#0a1628 0%,#0d1f1a 100%);border-radius:16px 16px 0 0;padding:28px 40px 22px;text-align:center;border:1px solid rgba(255,255,255,0.08);border-bottom:none;">
      <div style="font-size:22px;font-weight:800;color:#00cc00;letter-spacing:-0.5px;"><?php echo e(config('app.name')); ?></div>
  ...
  <tr>
    <td style="background:#161b27;padding:36px 40px;border:1px solid rgba(255,255,255,0.08);border-top:none;border-bottom:none;">
      <h2 style="color:#ffffff;font-size:22px;font-weight:700;margin:0 0 8px;">Welcome aboard, <?php echo e($user->name); ?>! &#127881;</h2>
      <p style="color:#7a8599;font-size:14px;margin:0 0 24px;line-height:1.6;">Your <?php echo e(config('app.name')); ?> account has been created successfully. We're excited to have you on board.</p>
      ...
      <table width="100%" cellpadding="0" cellspacing="0" role="presentation" style="margin-bottom:24px;">
        <tr>
          <td style="background:#1e2535;border:1px solid rgba(255,255,255,0.07);border-radius:12px;padding:18px 22px;">
            ...
            <div style="font-size:15px;color:#e4e8f0;font-weight:600;"><?php echo e($user->email); ?></div>
          </td>
        </tr>
      </table>
      ...
      <div style="text-align:center;margin:0 0 28px;">
        <!--[if mso]><v:roundrect xmlns:v="urn:schemas-microsoft-com:vml" href="<?php echo e(url('/dashboard')); ?>" style="height:48px;v-text-anchor:middle;width:220px;" arcsize="21%" stroke="f" fillcolor="#00cc00"><w:anchorlock/><center style="color:#000;font-family:sans-serif;font-size:15px;font-weight:700;">Get Started &rarr;</center></v:roundrect><![endif]-->
  ...
  <tr>
    <td style="background:#111720;border:1px solid rgba(255,255,255,0.08);border-top:1px solid rgba(255,255,255,0.05);border-radius:0 0 16px 16px;padding:24px 40px;">
      <p style="text-align:center;margin:0 0 12px;">
        <a href="<?php echo e(url('/dashboard')); ?>" style="color:#7a8599;font-size:12px;text-decoration:none;margin:0 10px;">Dashboard</a>
        <span style="color:rgba(255,255,255,0.15);">|</span>
        <a href="<?php echo e(url('/support')); ?>" style="color:#7a8599;font-size:12px;text-decoration:none;margin:0 10px;">Support</a>
        <span style="color:rgba(255,255,255,0.15);">|</span>
        <a href="<?php echo e(url('/')); ?>" style="color:#7a8599;font-size:12px;text-decoration:none;margin:0 10px;">Website</a>
      </p>
      <p style="color:#4a5568;font-size:11px;text-align:center;line-height:1.6;margin:0;">
        &copy; <?php echo e(date('Y')); ?> <strong style="color:#7a8599;"><?php echo e(config('app.name')); ?></strong>. All rights reserved.<br>
...
<?php /**PATH C:\xampp\htdocs\kayxchangev2\resources\views\emails\welcome.blade.php ENDPATH**/ ?>