            ...
            <div class="install-body">
                ...
                <form method="POST" action="<?php echo e(route('install.application.store')); ?>">
                    ...
                    <div class="config-section">
                        ...
                        <div class="form-floating">
                            <input type="text" class="form-control" id="app_name" name="app_name" 
                                   value="<?php echo e(old('app_name', 'KayXchange')); ?>" required>
                            <label for="app_name">Application Name</label>
                        </div>
                        
                        <div class="form-floating">
                            <input type="url" class="form-control" id="app_url" name="app_url" 
                                   value="<?php echo e(old('app_url', 'http://localhost')); ?>" required>
                        ...
                        <div id="email-config" class="collapsible-content">
                            <div class="form-floating">
                                <select class="form-select" id="mail_driver" name="mail_driver" required onchange="toggleMailFields()">
                                    <option value="smtp" <?php echo e(old('mail_driver') == 'smtp' ? 'selected' : ''); ?>>SMTP</option>
                                    <option value="mailgun" <?php echo e(old('mail_driver') == 'mailgun' ? 'selected' : ''); ?>>Mailgun</option>
                                    <option value="ses" <?php echo e(old('mail_driver') == 'ses' ? 'selected' : ''); ?>>Amazon SES</option>
                                    <option value="sendmail" <?php echo e(old('mail_driver') == 'sendmail' ? 'selected' : ''); ?>>Sendmail</option>
                                    <option value="log" <?php echo e(old('mail_driver') == 'log' ? 'selected' : ''); ?>>Log (Testing)</option>
                                </select>
                            ...
                            <div id="smtp-fields">
                                    ...
                                    <div class="col-md-8">
                                        <div class="form-floating">
                                            <input type="text" class="form-control" id="mail_host" name="mail_host" 
                                                   value="<?php echo e(old('mail_host')); ?>">
                                ...
                                <div class="form-floating">
                                    <select class="form-select" id="mail_encryption" name="mail_encryption">
                                        <option value="tls" <?php echo e(old('mail_encryption') == 'tls' ? 'selected' : ''); ?>>TLS</option>
                                        <option value="ssl" <?php echo e(old('mail_encryption') == 'ssl' ? 'selected' : ''); ?>>SSL</option>
                                        <option value="null" <?php echo e(old('mail_encryption') == 'null' ? 'selected' : ''); ?>>None</option>
                                    </select>
                        ...
                        <div id="telegram-config" class="collapsible-content">
                            <div class="form-floating">
                                <input type="text" class="form-control" id="telegram_bot_token" name="telegram_bot_token" 
                                       value="<?php echo e(old('telegram_bot_token')); ?>" placeholder="123456789:ABCdefGhIJKlmNoPQRstUVwxyz">
                        ...
                        <div id="payment-config" class="collapsible-content">
                            <div class="form-floating">
                                <input type="text" class="form-control" id="paystack_public_key" name="paystack_public_key" 
                                       value="<?php echo e(old('paystack_public_key')); ?>" placeholder="pk_test_...">
                            ...
                            <div class="form-floating">
                                <input type="password" class="form-control" id="paystack_secret_key" name="paystack_secret_key" 
                                       value="<?php echo e(old('paystack_secret_key')); ?>" placeholder="sk_test_...">
                    ...
                    <div class="d-flex justify-content-between mt-4">
                        <a href="<?php echo e(route('install.database')); ?>" class="btn btn-outline-secondary">
...
</html><?php /**PATH C:\xampp\htdocs\kayxchangev2\resources\views\install\application.blade.php ENDPATH**/ ?>