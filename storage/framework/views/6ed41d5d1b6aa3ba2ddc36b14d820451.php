...
<?php $__env->startSection('title', 'Make a Deposit'); ?>
...
<div class="dep-wrap">
    ...
    <form id="deposit-form" action="<?php echo e(route('deposits.store')); ?>" method="POST" enctype="multipart/form-data">
        <?php echo csrf_field(); ?>
...
$message = $__bag->first($__errorArgs[0]); ?><div class="kx-error"><i class="bi bi-exclamation-circle me-1"></i><?php echo e($message); ?></div><?php unset($message);
...
unset($__errorArgs, $__bag); ?>
            ...
            <div class="mb-0">
                ...
                <input type="hidden" name="payment_method" id="payment_method" value="<?php echo e(old('payment_method')); ?>">

                <div class="kx-method-grid" id="method-grid">
                    
                    <?php if($enabledMethods['bank_transfer']): ?>
                    <div class="kx-method-card <?php echo e(old('payment_method') === 'bank_transfer' ? 'selected' : ''); ?>" data-value="bank_transfer" onclick="selectMethod('bank_transfer')">
                    ...
                    <?php if($enabledMethods['crypto_transfer']): ?>
                    <div class="kx-method-card <?php echo e(old('payment_method') === 'crypto_transfer' ? 'selected' : ''); ?>" data-value="crypto_transfer" onclick="selectMethod('crypto_transfer')">
                    ...
                    <?php if($enabledMethods['paystack']): ?>
                    <div class="kx-method-card <?php echo e(old('payment_method') === 'paystack' ? 'selected' : ''); ?>" data-value="paystack" onclick="selectMethod('paystack')">
                    ...
                    <?php if($enabledMethods['korapay']): ?>
                    <div class="kx-method-card <?php echo e(old('payment_method') === 'korapay' ? 'selected' : ''); ?>" data-value="korapay" onclick="selectMethod('korapay')">
                    ...
                    <?php if($enabledMethods['flutterwave']): ?>
                    <div class="kx-method-card <?php echo e(old('payment_method') === 'flutterwave' ? 'selected' : ''); ?>" data-value="flutterwave" onclick="selectMethod('flutterwave')">
                    ...
                    <?php if(!array_filter($enabledMethods)): ?>
...
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?><div class="kx-error mt-2"><i class="bi bi-exclamation-circle me-1"></i><?php echo e($message); ?></div><?php unset($message);
if (isset($__messageOriginal)) { $message = $__messageOriginal; }
endif;
unset($__errorArgs, $__bag); ?>
            </div>
        ...
        <div class="dep-card d-none" id="company-account-section">
            ...
            <div class="mb-3">
                ...
                <select name="company_account_id" id="company_account_id" class="kx-select">
                    ...
                    <?php $__currentLoopData = $companyAccounts; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $account): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <option value="<?php echo e($account->id); ?>"
                                data-bank-name="<?php echo e($account->bank_name); ?>"
                                data-account-number="<?php echo e($account->account_number); ?>"
                                data-account-name="<?php echo e($account->account_name); ?>"
                                <?php echo e(old('company_account_id') == $account->id ? 'selected' : ''); ?>>
                            <?php echo e($account->account_name); ?> — <?php echo e($account->bank_name); ?>

                        </option>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                </select>
                <?php $__errorArgs = ['company_account_id'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?><div class="kx-error"><i class="bi bi-exclamation-circle me-1"></i><?php echo e($message); ?></div><?php unset($message);
...
unset($__errorArgs, $__bag); ?>
                ...
                <select name="crypto_wallet_key" id="crypto_wallet_key" class="kx-select d-none">
                    ...
                    <?php $__currentLoopData = ($cryptoWallets ?? []); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $wallet): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <option value="<?php echo e($wallet['key']); ?>"
                                data-network="<?php echo e($wallet['network']); ?>"
                                data-wallet-name="<?php echo e($wallet['name']); ?>"
                                data-wallet-address="<?php echo e($wallet['address']); ?>"
                                <?php echo e(old('crypto_wallet_key') === $wallet['key'] ? 'selected' : ''); ?>>
                            <?php echo e($wallet['name']); ?> — <?php echo e($wallet['network']); ?>

                        </option>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                </select>
                <?php $__errorArgs = ['crypto_wallet_key'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?><div class="kx-error"><i class="bi bi-exclamation-circle me-1"></i><?php echo e($message); ?></div><?php unset($message);
...
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?><div class="kx-error mt-1"><i class="bi bi-exclamation-circle me-1"></i><?php echo e($message); ?></div><?php unset($message);
if (isset($__messageOriginal)) { $message = $__messageOriginal; }
endif;
unset($__errorArgs, $__bag); ?>
            </div>
...
(function () {
    ...
    const gatewayAction      = '<?php echo e(route("deposits.initiate")); ?>';
...
<?php echo $__env->make('layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\kayxchangev2\resources\views/deposits/create.blade.php ENDPATH**/ ?>