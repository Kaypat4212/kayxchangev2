...
<div class="kx-welcome">
    <div class="row align-items-center">
        ...
        <div class="col-auto d-none d-md-flex gap-2 align-items-center">
            <?php $siteMode = $siteMode ?? 'production'; ?>
            <button id="kx-mode-toggle-btn"
                class="kx-mode-badge <?php echo e($siteMode === 'developer' ? 'mode-developer' : 'mode-production'); ?>"
                data-mode="<?php echo e($siteMode); ?>"
                title="Click to toggle site mode">
                <span class="kx-mode-dot"></span>
                <span><?php echo e($siteMode === 'developer' ? 'Developer Mode' : 'Production Mode'); ?></span>
                <i class="bi bi-arrow-repeat" style="font-size:0.7rem;opacity:0.7"></i>
            </button>
            <a href="<?php echo e(url('/')); ?>" target="_blank" class="btn-kx-outline">
...
<div class="row g-3 mb-4">
    <div class="col-6 col-md-4 col-lg-2">
        <div class="kx-stat">
            ...
            <div>
                <div class="kx-stat-val"><?php echo e($totalUsers); ?></div>
    ...
    <div class="col-6 col-md-4 col-lg-2">
        <div class="kx-stat">
            ...
            <div>
                <div class="kx-stat-val"><?php echo e($totalReferrals); ?></div>
    ...
    <div class="col-6 col-md-4 col-lg-2">
        <div class="kx-stat">
            ...
            <div>
                <div class="kx-stat-val">&#8358;<?php echo e(number_format($totalReferralRewards, 0)); ?></div>
                <div class="kx-stat-label">Ref. Rewards</div>
            </div>
        </div>
    </div>
    <div class="col-6 col-md-4 col-lg-2">
        <a href="<?php echo e(url('/admin/withdrawals')); ?>" class="kx-stat">
    ...
    <div class="col-6 col-md-4 col-lg-2">
        <a href="<?php echo e(url('/admin/kyc')); ?>" class="kx-stat">
    ...
    <div class="col-6 col-md-4 col-lg-2">
        <a href="<?php echo e(url('/admin/trades')); ?>" class="kx-stat">
...
<div class="row g-3 mb-4">
    <div class="col-6 col-md-3">
        <a href="<?php echo e(url('/admin/withdrawals')); ?>" class="kx-nav-card">
    ...
    <div class="col-6 col-md-3">
        <a href="<?php echo e(url('/admin/kyc')); ?>" class="kx-nav-card">
    ...
    <div class="col-6 col-md-3">
        <a href="<?php echo e(url('/admin/trades')); ?>" class="kx-nav-card">
    ...
    <div class="col-6 col-md-3">
        <a href="<?php echo e(url('/admin/notifications')); ?>" class="kx-nav-card">
...
<div class="row g-4">
    ...
    <div class="col-lg-7">
        ...
        <div class="kx-panel">
            ...
            <div class="kx-panel-body">
                <form id="company-account-form" action="<?php echo e(route('admin.company-account')); ?>" method="POST">
                    <?php echo csrf_field(); ?>
    ...
    <div class="col-lg-5">
        ...
        <div class="kx-panel">
            <div class="kx-panel-header">
                ...
                <a href="<?php echo e(url('/admin/notifications')); ?>" class="btn-kx-outline">
        ...
        <div class="kx-panel">
            ...
            <div class="kx-panel-body d-flex flex-column gap-3">
                <a href="<?php echo e(route('admin.deposits.index')); ?>" class="kx-nav-card" style="padding:14px;height:auto">
                ...
                <a href="<?php echo e(route('admin.withdrawals')); ?>" class="kx-nav-card" style="padding:14px;height:auto">
                ...
                <a href="<?php echo e(url('/admin/notifications')); ?>" class="kx-nav-card" style="padding:14px;height:auto">
                ...
                <a href="<?php echo e(url('/admin/users')); ?>" class="kx-nav-card" style="padding:14px;height:auto">
                ...
                <a href="<?php echo e(url('/admin/sells')); ?>" class="kx-nav-card" style="padding:14px;height:auto">
                ...
                <a href="<?php echo e(url('/admin/crypto-rates')); ?>" class="kx-nav-card" style="padding:14px;height:auto">
        ...
        <div class="kx-panel">
            ...
            <div class="kx-panel-body">
                <div class="row g-2">
                    <div class="col-6"><a href="<?php echo e(url('/admin/users')); ?>" class="btn-kx-outline w-100 justify-content-center"><i class="bi bi-people me-1"></i>Users</a></div>
                    <div class="col-6"><a href="<?php echo e(url('/admin/trades')); ?>" class="btn-kx-outline w-100 justify-content-center"><i class="bi bi-arrow-left-right me-1"></i>Trades</a></div>
                    <div class="col-6"><a href="<?php echo e(route('admin.deposits.index')); ?>" class="btn-kx-outline w-100 justify-content-center"><i class="bi bi-wallet2 me-1"></i>Deposits</a></div>
                    <div class="col-6"><a href="<?php echo e(route('admin.withdrawals')); ?>" class="btn-kx-outline w-100 justify-content-center"><i class="bi bi-bank me-1"></i>Withdrawals</a></div>
                    <div class="col-6"><a href="<?php echo e(url('/admin/kyc')); ?>" class="btn-kx-outline w-100 justify-content-center"><i class="bi bi-patch-check me-1"></i>KYC</a></div>
                    <div class="col-6"><a href="<?php echo e(url('/admin/notifications')); ?>" class="btn-kx-outline w-100 justify-content-center"><i class="bi bi-bell me-1"></i>Notifications</a></div>
                    <div class="col-6"><a href="<?php echo e(url('/admin/crypto-rates')); ?>" class="btn-kx-outline w-100 justify-content-center"><i class="bi bi-currency-bitcoin me-1"></i>Crypto Rates</a></div>
                    <div class="col-6"><a href="<?php echo e(url('/admin/gift-card-rates')); ?>" class="btn-kx-outline w-100 justify-content-center"><i class="bi bi-gift me-1"></i>Gift Card Rates</a></div>
                    <div class="col-6"><a href="<?php echo e(url('/admin/blog')); ?>" class="btn-kx-outline w-100 justify-content-center"><i class="bi bi-journal-richtext me-1"></i>Blog</a></div>
                    <div class="col-6"><a href="<?php echo e(url('/admin/site-content')); ?>" class="btn-kx-outline w-100 justify-content-center"><i class="bi bi-pencil-square me-1"></i>Site Content</a></div>
                    <div class="col-6"><a href="<?php echo e(url('/admin/chat')); ?>" class="btn-kx-outline w-100 justify-content-center"><i class="bi bi-chat-dots me-1"></i>Admin Chat</a></div>
                    <div class="col-6"><a href="<?php echo e(url('/admin/email-settings')); ?>" class="btn-kx-outline w-100 justify-content-center"><i class="bi bi-envelope-gear me-1"></i>Email Settings</a></div>
                    <div class="col-6"><a href="<?php echo e(route('admin.email-templates')); ?>" class="btn-kx-outline w-100 justify-content-center"><i class="bi bi-envelope-paper me-1"></i>Email Templates</a></div>
                    <div class="col-6"><a href="<?php echo e(url('/admin/env-editor')); ?>" class="btn-kx-outline w-100 justify-content-center"><i class="bi bi-key me-1"></i>API Keys</a></div>
                    <div class="col-6"><a href="<?php echo e(url('/admin/telegram')); ?>" class="btn-kx-outline w-100 justify-content-center"><i class="bi bi-telegram me-1"></i>Telegram Bot</a></div>
                </div>
            </div>
        </div>
...
document.addEventListener('DOMContentLoaded', () => {
    ...
    document.getElementById('kx-mode-confirm-btn').addEventListener('click', function () {
        ...
        fetch('<?php echo e(route("admin.site-mode.toggle")); ?>', {
            method: 'POST',
    ...
    // Pending counts
    const fetchCounts = () => {
        fetch('<?php echo e(route("admin.pending-counts")); ?>', { headers: { 'Accept':'application/json', 'X-CSRF-TOKEN': csrf() } })
        .then(r => r.ok ? r.json() : Promise.reject())
        .then(data => {
    ...
    // Load crypto rates
    fetch('<?php echo e(route("admin.rates")); ?>', { headers: { 'Accept':'application/json', 'X-CSRF-TOKEN': csrf() } })
    .then(r => r.ok ? r.json() : Promise.reject())
    .then(data => {
    ...
    document.getElementById('rates-form').addEventListener('submit', e => {
        ...
        fetch('<?php echo e(route("admin.rates.update")); ?>', {
            method: 'POST',
    ...
    fetch('<?php echo e(route("admin.company-account")); ?>', { headers: { 'Accept':'application/json', 'X-CSRF-TOKEN': csrf() } })
    .then(r => r.ok ? r.json() : Promise.reject())
    .then(data => {
    ...
    document.getElementById('company-account-form').addEventListener('submit', e => {
        ...
        feedback.innerHTML = ''; btn.disabled = true; spin.style.display = 'inline-block';
        fetch('<?php echo e(route("admin.company-account.update")); ?>', {
            method: 'POST',
            headers: { 'Accept':'application/json', 'X-CSRF-TOKEN': csrf() },
    ...
    fetch('<?php echo e(route("admin.notifications.index")); ?>?per_page=5', {
        headers: {
...
(function(){
    ...
    form.addEventListener('submit', async function(e){
        ...
        try {
            const res  = await fetch('<?php echo e(route("ai.report")); ?>', {
                method: 'POST',
...
<?php echo $__env->make('adminnavlayout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\kayxchangev2\resources\views/admin/dashboard.blade.php ENDPATH**/ ?>