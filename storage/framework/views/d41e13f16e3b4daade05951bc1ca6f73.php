            ...
            <div class="navbar-nav me-auto">
                ...
                <div class="nav-item dropdown">
                    ...
                    <ul class="dropdown-menu">
                        <li><a class="dropdown-item" href="<?php echo e(url('/Learn.html')); ?>"><i class="bi bi-book me-2"></i>Learn</a></li>
                        <li><a class="dropdown-item" href="<?php echo e(url('/blog')); ?>"><i class="bi bi-newspaper me-2"></i>Blog</a></li>
                        <li><a class="dropdown-item" href="<?php echo e(url('/alts.html')); ?>"><i class="bi bi-currency-exchange me-2"></i>Alts</a></li>
                        <li><a class="dropdown-item" href="<?php echo e(url('/Fiats.html')); ?>"><i class="bi bi-bank me-2"></i>Fiats</a></li>
                    </ul>
                </div>
            </div>
...
<?php echo $__env->make('layouts.header', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\kayxchangev2\resources\views\layouts\nav.blade.php ENDPATH**/ ?>