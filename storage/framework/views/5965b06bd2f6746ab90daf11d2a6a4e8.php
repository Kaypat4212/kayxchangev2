...
<div class="container-fluid">
    ...
    <div class="d-flex align-items-center justify-content-between mb-4">
        <div>
            ...
            <div class="adm-page-sub"><?php echo e($users->count()); ?> user<?php echo e($users->count() !== 1 ? "s" : ""); ?> with open conversations</div>
        </div>
    </div>
    ...
    <div class="adm-card adm-sup-layout">
        <div class="adm-user-list">
            ...
            <div class="adm-user-item <?php echo e($loop->first ? "active" : ""); ?>"
                 data-uid="<?php echo e($u->id); ?>"
                 data-name="<?php echo e($u->name); ?>"
                 data-email="<?php echo e($u->email); ?>"
                 onclick="selectUser(this)">
                <div class="adm-user-avatar"><?php echo e(strtoupper(substr($u->name,0,1))); ?></div>
                <div style="min-width:0;flex:1">
                    <div class="adm-user-name"><?php echo e($u->name); ?></div>
                    <div class="adm-user-last"><?php echo e($u->email); ?></div>
                </div>
                <?php if($u->unread_count > 0): ?>
                <span class="adm-unread-badge"><?php echo e($u->unread_count); ?></span>
                <?php endif; ?>
            </div>
        ...
        <div class="adm-chat-panel">
            ...
            <div class="adm-chat-header" id="adm-chat-header">
                <div class="adm-user-avatar" id="adm-hdr-avatar"><?php echo e(strtoupper(substr($users->first()->name,0,1))); ?></div>
                <div>
                    <div class="adm-chat-name" id="adm-hdr-name"><?php echo e($users->first()->name); ?></div>
                    <div class="adm-chat-email" id="adm-hdr-email"><?php echo e($users->first()->email); ?></div>
                </div>
            </div>
...
(function () {
    ...
    var adminId  = <?php echo e(Auth::id()); ?>;
    var activeUid= <?php echo e($users->isNotEmpty() ? $users->first()->id : 'null'); ?>;
    var historyBaseUrl = <?php echo json_encode(url('/chat/history'), 15, 512) ?>;
    var pollUrl = <?php echo json_encode(route('chat.poll'), 15, 512) ?>;
    var adminSendUrl = <?php echo json_encode(route('chat.send.admin'), 15, 512) ?>;
    var lastId   = 0;
    var pollTimer;
...
<?php echo $__env->make('adminnavlayout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\kayxchangev2\resources\views\admin\chat.blade.php ENDPATH**/ ?>