...
<div class="col-xl-8 col-lg-9">
    ...
    <div class="calc-card sell-mode" id="calcCard">
        ...
        <div class="kx-coin-grid" id="coinGrid">
            <?php $__currentLoopData = ['BTC' => ['Bitcoin','icon-btc','BTC'], 'ETH' => ['Ethereum','icon-eth','ETH'], 'USDT' => ['Tether','icon-usdt','₮']]; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $symbol => [$name, $iconCls, $symIcon]): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <?php $r = $rates[$symbol] ?? null; ?>
            <div class="kx-coin-btn <?php echo e($loop->first ? 'active' : ''); ?>"
                 id="coin-btn-<?php echo e($symbol); ?>"
                 onclick="selectCoin('<?php echo e($symbol); ?>')"
                 data-coin="<?php echo e($symbol); ?>">
                <div class="coin-icon-w <?php echo e($iconCls); ?>"><?php echo e($symIcon); ?></div>
                <div class="coin-name-lbl"><?php echo e($symbol); ?></div>
                <div class="coin-rate-lbl" id="coin-rate-<?php echo e($symbol); ?>">
                    <?php if($r): ?>₦<?php echo e(number_format($r->sell_rate, 0)); ?>/USD@else—<?php endif; ?>
                </div>
            </div>
        ...
        <div class="calc-cta-row" id="ctaRow">
            <a href="<?php echo e(url('/sell')); ?>" class="calc-cta sell-cta" id="ctaBtn">
        ...
        <div class="table-responsive">
            <table class="rates-table">
                ...
                <tbody id="ratesTableBody">
                    <?php $__currentLoopData = $rates; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $symbol => $r): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <?php
                    ...
                    <tr>
                        <td>
                            <div class="coin-cell">
                                <div class="coin-cell-icon <?php echo e($ic); ?>" style="font-size:.8rem;"><?php echo e($sym); ?></div>
                                <div>
                                    <div style="font-weight:700;color:#fff;font-size:.88rem;"><?php echo e($symbol); ?></div>
                                    <div style="font-size:.7rem;color:var(--kx-muted);">
                                        <?php if($symbol==='BTC'): ?> Bitcoin <?php elseif($symbol==='ETH'): ?> Ethereum <?php else: ?> Tether <?php endif; ?>
                                    </div>
                                </div>
                            </div>
                        </td>
                        <td><span class="buy-rate-val">₦<?php echo e(number_format($r->buy_rate, 2)); ?></span></td>
                        <td><span class="sell-rate-val">₦<?php echo e(number_format($r->sell_rate, 2)); ?></span></td>
                        <td><span class="spread-val">₦<?php echo e(number_format(abs($r->buy_rate - $r->sell_rate), 2)); ?></span></td>
                    </tr>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                </tbody>
            </table>
...
(function(){
    ...
    const rates = <?php echo json_encode($rates->map(fn($r) => ['buy_rate' => (float)$r->buy_rate, 'sell_rate' => (float)$r->sell_rate]), 512) ?>;
    ...
    function refreshRates() {
        fetch('<?php echo e(route("calc.rates")); ?>')
            .then(r => r.json())
            .then(data => {
...
<?php echo $__env->make('layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\kayxchangev2\resources\views/rates/calculator.blade.php ENDPATH**/ ?>