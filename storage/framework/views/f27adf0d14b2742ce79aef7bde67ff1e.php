...
<div class="col-xl-7 col-lg-8 col-md-10">
    ...
    <div class="kx-stats">
        <div class="kx-stat">
            <div class="s-val"><?php echo e($referrals->total()); ?></div>
            <div class="s-lbl">Total Referred</div>
        </div>
        <div class="kx-stat">
            <div class="s-val"><?php echo e($referrals->where('status','completed')->count()); ?></div>
            <div class="s-lbl">Completed</div>
        </div>
        <div class="kx-stat">
            <div class="s-val">&#8358;<?php echo e(number_format($totalRewards, 0)); ?></div>
        ...
        <div class="mb-3">
            ...
            <div class="kx-copy-group">
                <input type="text" id="codeInput" class="kx-copy-input" readonly
                    value="<?php echo e($user->code ?? $user->referral_code); ?>">
        ...
        <div class="mb-2">
            ...
            <div class="kx-copy-group">
                <input type="text" id="linkInput" class="kx-copy-input" readonly
                    value="<?php echo e($referral_link ?? $referralLink); ?>">
    ...
    <div class="kx-card">
        <div class="kx-card-title"><i class="bi bi-people-fill"></i>Your Referrals
            <span style="margin-left:auto;font-size:.72rem;font-weight:400;color:var(--kx-muted);">
                <?php echo e($referrals->total()); ?> total
            </span>
        </div>
                    ...
                    <tr>
                        <td>
                            <div class="d-flex align-items-center gap-2">
                                <div class="avatar-pill"><?php echo e($initials); ?></div>
                                <div>
                                    <div style="font-size:.82rem;font-weight:600;color:var(--kx-text);">
                                        <?php echo e($referral->nickname ?? $email); ?>

                                    </div>
                                    <?php if($referral->nickname): ?>
                                    <div style="font-size:.7rem;color:var(--kx-muted);"><?php echo e($email); ?></div>
                                    <?php endif; ?>
                                </div>
                            </div>
                        </td>
                        <td class="text-center" style="color:var(--kx-green);font-weight:600;">
                            &#8358;<?php echo e(number_format($referral->reward_amount ?? 0, 0)); ?>

                        </td>
                        <td class="text-center">
                            <span class="status-pill <?php echo e($status); ?>">
...
<?php echo $__env->make('layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\kayxchangev2\resources\views\referrals\index.blade.php ENDPATH**/ ?>