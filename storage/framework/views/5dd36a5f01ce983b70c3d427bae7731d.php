...
<div class="container my-5">
    ...
    <form method="POST" action="<?php echo e(route('update.bank')); ?>">
        <?php echo csrf_field(); ?>
        <div class="form-group mb-3">
            <label for="bank_code">Bank Name</label>
            <select name="bank_code" id="bank_code" class="form-control" <?php echo e($bankDetailsSet ? 'disabled' : ''); ?> required>
...
unset($__errorArgs, $__bag); ?>
        ...
        <div class="form-group mb-3">
            ...
            <input type="text" name="account_number" id="account_number" class="form-control" 
                   value="<?php echo e(old('account_number', $user->account_number)); ?>" 
                   <?php echo e($bankDetailsSet ? 'disabled' : ''); ?> required>
...
unset($__errorArgs, $__bag); ?>
        ...
        <div class="form-group mb-3">
            ...
            <input type="text" name="account_name" id="account_name" class="form-control" 
                   value="<?php echo e(old('account_name', $user->account_name)); ?>" 
                   <?php echo e($bankDetailsSet ? 'disabled' : ''); ?> readonly required>
...
$(document).ready(function() {
    // Fetch banks
    $.ajax({
        url: '<?php echo e(route('paystack.banks')); ?>',
        method: 'GET',
        success: function(response) {
            if (response.status && response.data) {
                ...
                <?php if($user->bank_code): ?>
                    $('#bank_code').val('<?php echo e($user->bank_code); ?>');
                <?php endif; ?>
            } else {
    ...
    $('#account_number').on('input', function() {
        ...
        if (accountNumber.length >= 10 && bankCode) {
            ...
            $.ajax({
                url: '<?php echo e(route('paystack.resolve-account')); ?>',
                method: 'POST',
                data: {
    ...
    // Load chat history
    $.get('<?php echo e(route('chat.history')); ?>', function(messages) {
...
<?php echo $__env->make('layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\kayxchangev2\resources\views/settings/edit-bank.blade.php ENDPATH**/ ?>