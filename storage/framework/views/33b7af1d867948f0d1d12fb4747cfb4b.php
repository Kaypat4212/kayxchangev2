...
<body class="bg-gray-100 flex items-center justify-center min-h-screen">
    <div class="bg-white p-8 rounded-lg shadow-lg w-full max-w-md animate__animated fade-in">
        ...
        <form action="<?php echo e(route('feature.request.submit')); ?>" method="POST" enctype="multipart/form-data">
            <?php echo csrf_field(); ?>
            <div class="mb-4">
...
</html><?php /**PATH C:\xampp\htdocs\kayxchangev2\resources\views\feature-request.blade.php ENDPATH**/ ?>