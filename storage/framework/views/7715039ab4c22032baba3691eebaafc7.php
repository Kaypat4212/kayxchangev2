...
<div class="container-fluid py-3 px-3 px-md-4">
    <div class="kx-page-header">
        <div>
            ...
            <small>View and manage all registered users (<?php echo e($users->count()); ?> total)</small>
        </div>
    ...
    <div class="kx-panel">
        <div class="kx-panel-header">
            ...
            <span style="font-size:.75rem;color:var(--kx-muted)"><?php echo e($users->count()); ?> users</span>
        </div>
        <div class="kx-table-wrap">
            <table class="kx-table" id="usersTable">
                ...
                <tr>
                    <td><span style="color:var(--kx-muted)">#<?php echo e($user->id); ?></span></td>
                    <td>
                    ...
                    <td style="color:var(--kx-muted)"><?php echo e($user->email); ?></td>
                    <td>₦<?php echo e(number_format($user->balance ?? 0, 2)); ?></td>
                    <td>
                    ...
                    <td style="font-size:.75rem;color:var(--kx-muted)"><?php echo e($user->created_at->format('d M Y')); ?></td>
                    <td>
                        <div class="d-flex gap-1 flex-wrap">
                            <a href="<?php echo e(route('admin.users.show', $user->id)); ?>" class="btn-kx-outline" style="font-size:.72rem;padding:.25rem .6rem">
                                <i class="bi bi-eye"></i>
                            </a>
                            <a href="<?php echo e(route('admin.users.edit', $user->id)); ?>" class="btn-kx-edit">
                                <i class="bi bi-pencil"></i>
                            </a>
                            <form action="<?php echo e(route('admin.users.destroy', $user->id)); ?>" method="POST" style="display:inline" onsubmit="return confirm('Delete <?php echo e(addslashes($user->name)); ?>?')">
...
<?php echo $__env->make('adminnavlayout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\kayxchangev2\resources\views\admin\users.blade.php ENDPATH**/ ?>