...
<div class="col-xl-6 col-lg-7">
    ...
    <div class="kx-summary-hero">
        ...
        <div class="kx-ref">REF: <?php echo e($trade->transaction_ref); ?></div>
    </div>
        ...
        <div class="kx-card-bd">
            <div class="kx-detail-row">
                ...
                <span class="kx-detail-value">
                    <span class="kx-status <?php echo e($trade->status); ?>">
                        <?php if($trade->status === 'pending'): ?><i class="bi bi-hourglass-split me-1"></i>
                        <?php elseif(in_array($trade->status,['approved','completed'])): ?><i class="bi bi-check-circle-fill me-1"></i>
                        <?php elseif(in_array($trade->status,['rejected','failed'])): ?><i class="bi bi-x-circle-fill me-1"></i>
                        <?php else: ?><i class="bi bi-arrow-repeat me-1"></i><?php endif; ?>
            ...
            <div class="kx-detail-row">
                ...
                <span class="kx-detail-value"><?php echo e($trade->coin); ?></span>
            </div>
            <div class="kx-detail-row">
                <span class="kx-detail-label">USD Amount</span>
                <span class="kx-detail-value">$<?php echo e(number_format($trade->usd_amount, 2)); ?></span>
            </div>
            <div class="kx-detail-row">
                <span class="kx-detail-label">Naira Payout</span>
                <span class="kx-detail-value green">₦<?php echo e(number_format($trade->naira_amount, 2)); ?></span>
            </div>
            <div class="kx-detail-row">
                <span class="kx-detail-label">Payout Method</span>
                <span class="kx-detail-value">
                    <?php $methods=['default_bank'=>'Default Bank','external_bank'=>'External Bank','wallet_balance'=>'Wallet Balance']; ?>
                    <?php echo e($methods[$trade->payment_method] ?? ucfirst(str_replace('_',' ',$trade->payment_method))); ?>

                </span>
            </div>
            <?php if($trade->bank_name): ?>
            <div class="kx-detail-row">
                <span class="kx-detail-label">Bank</span>
                <span class="kx-detail-value"><?php echo e($trade->bank_name); ?></span>
            </div>
            <?php endif; ?>
            <?php if($trade->account_number): ?>
            <div class="kx-detail-row">
                <span class="kx-detail-label">Account No.</span>
                <span class="kx-detail-value mono"><?php echo e($trade->account_number); ?></span>
            </div>
            <?php endif; ?>
            <?php if($trade->account_name): ?>
            <div class="kx-detail-row">
                <span class="kx-detail-label">Account Name</span>
                <span class="kx-detail-value"><?php echo e($trade->account_name); ?></span>
            </div>
            <?php endif; ?>
            <?php if($trade->wallet_address): ?>
            <div class="kx-detail-row">
                <span class="kx-detail-label">Wallet Used</span>
                <span class="kx-detail-value mono"><?php echo e(Str::limit($trade->wallet_address, 24)); ?></span>
            </div>
            <?php endif; ?>
            <div class="kx-detail-row">
                <span class="kx-detail-label">Date</span>
                <span class="kx-detail-value"><?php echo e($trade->created_at->format('M j, Y · g:i A')); ?></span>
            </div>
        </div>
    </div>
    ...
    <div class="kx-card">
        ...
        <div class="kx-proof-box">
            <?php if(in_array($proofExt, ['jpg','jpeg','png'])): ?>
                <img src="<?php echo e($proofUrl); ?>" alt="Payment proof" class="kx-proof-img">
            <?php else: ?>
                <a href="<?php echo e($proofUrl); ?>" target="_blank" class="kx-proof-pdf">
    ...
    <div class="d-flex gap-3" style="margin-bottom:2rem;">
        <a href="<?php echo e(route('dashboard')); ?>" class="kx-btn kx-btn-outline flex-fill">
            <i class="bi bi-house"></i> Dashboard
        </a>
        <a href="<?php echo e(route('transactions.history')); ?>" class="kx-btn kx-btn-primary flex-fill">
...
<?php echo $__env->make('selllayout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\kayxchangev2\resources\views\sell\summary.blade.php ENDPATH**/ ?>