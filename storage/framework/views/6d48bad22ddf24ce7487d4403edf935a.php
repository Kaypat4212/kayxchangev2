...
<div class="container-fluid px-3 px-md-4 py-4">
    ...
    <div class="kx-page-header d-flex align-items-center justify-content-between flex-wrap gap-2">
        ...
        <a href="<?php echo e(route('admin.email-settings.index')); ?>" class="btn btn-sm btn-outline-secondary">
        ...
        <div class="tpl-row">
            <div style="flex:1;min-width:0;">
                <div class="d-flex align-items-center gap-2 flex-wrap mb-1">
                    <span class="tpl-key"><?php echo e($tpl->key); ?></span>
                    <span class="tpl-subject"><?php echo e($tpl->subject); ?></span>
                </div>
                <?php if($tpl->description): ?>
                <div class="tpl-desc"><?php echo e($tpl->description); ?></div>
                <?php endif; ?>
            </div>
            <a href="<?php echo e(route('admin.email-templates.edit', $tpl->key)); ?>" class="btn-edit">
...
<?php echo $__env->make('adminnavlayout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\kayxchangev2\resources\views\admin\email-templates.blade.php ENDPATH**/ ?>