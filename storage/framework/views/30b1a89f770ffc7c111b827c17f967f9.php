...
<head>
    ...
    <title><?php echo e(config('app.name', 'KayXchange')); ?> — Buy</title>
...
<body>
    ...
    <nav class="kx-bottom-nav" aria-label="Mobile navigation">
        ...
        <div class="kx-bnav-item kx-bnav-center">
            <a href="<?php echo e(url('/buy')); ?>" class="kx-bnav-center-btn kx-bnav-active" title="Buy Crypto"><i class="bi bi-arrow-down-circle-fill"></i></a>
...
</html><?php /**PATH C:\xampp\htdocs\kayxchangev2\resources\views\buylayout.blade.php ENDPATH**/ ?>