...
<div class="col-xl-6 col-lg-7">
    ...
    <div class="sell-hero">
        ...
        <p>Select how you'd like to receive ₦<?php echo e(number_format($nairaAmount, 2)); ?></p>
    </div>
    ...
    <div class="kx-amount-bar">
        <div class="kx-amount-pill">
            ...
            <div class="val"><?php echo e($coin); ?> · $<?php echo e(number_format($amountInUsd,2)); ?></div>
        </div>
        <div class="kx-amount-pill highlight">
            <div class="lbl">You Receive</div>
            <div class="val">₦<?php echo e(number_format($nairaAmount,2)); ?></div>
        </div>
    </div>

    <form method="POST" action="<?php echo e(route('sell.finalize')); ?>" id="finalizeForm">
        <?php echo csrf_field(); ?>
            ...
            <div class="kx-card-bd" style="padding:.85rem;">
                <div class="kx-method">
                    ...
                    <div class="kx-method-card" id="card_default_bank" onclick="selectMethod('default_bank')">
                        <div class="kx-method-top">
                            ...
                            <div class="kx-method-info">
                                ...
                                <div class="sub">
                                    <?php echo e($userData['bank_name'] ?? 'Saved bank'); ?>

                                    <?php if(!empty($userData['account_number'])): ?>· ****<?php echo e(substr($userData['account_number'],-4)); ?><?php endif; ?>
                                </div>
                            </div>
                        </div>
                        <div class="kx-method-body">
                            ...
                            <div style="background:rgba(0,204,0,.05);border:1px solid rgba(0,204,0,.12);border-radius:10px;padding:.75rem;font-size:.82rem;margin-bottom:.9rem;">
                                ...
                                <div style="color:#fff;font-weight:600;"><?php echo e($userData['bank_name'] ?? '—'); ?></div>
                                <div style="color:var(--kx-muted);"><?php echo e($userData['account_number'] ?? '—'); ?> &nbsp;·&nbsp; <?php echo e($userData['account_name'] ?? ''); ?></div>
                            </div>
                    ...
                    <div class="kx-method-card" id="card_wallet_balance" onclick="selectMethod('wallet_balance')">
                        ...
                        <div class="kx-method-body">
                            <div class="kx-method-divider"></div>
                            <div class="kx-balance-badge"><i class="bi bi-wallet2"></i> Balance: ₦<?php echo e(number_format($balance, 2)); ?></div>
                            <label class="kx-label">Confirm Password</label>
...
function loadBanks() {
    ...
    $.get('<?php echo e(route('sell.fetchBanks')); ?>', function(res) {
...
function doValidate() {
    ...
    $.ajax({
        url: '<?php echo e(route('sell.validateBank')); ?>',
        method: 'POST',
        data: { _token: '<?php echo e(csrf_token()); ?>', bank_name: bankCode, alt_bank_name: bankName, account_number: accNo },
        success: function(r) {
...
<?php echo $__env->make('selllayout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\kayxchangev2\resources\views\sell\step3.blade.php ENDPATH**/ ?>