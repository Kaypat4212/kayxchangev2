...
<head>
    ...
    <title><?php echo e(config('app.name', 'KayXchange')); ?> — Dashboard</title>
...
<body>
    ...
    <nav class="kx-bottom-nav" id="kxBottomNav" aria-label="Mobile navigation">
        <a href="<?php echo e(url('/dashboard')); ?>"
           class="kx-bnav-item <?php if(request()->is('dashboard')): ?> kx-bnav-active <?php endif; ?>">
            <i class="bi bi-grid-1x2-fill"></i><span>Home</span>
        </a>
        <a href="<?php echo e(url('/rate')); ?>"
           class="kx-bnav-item <?php if(request()->is('rate')): ?> kx-bnav-active <?php endif; ?>">
            <i class="bi bi-graph-up-arrow"></i><span>Rates</span>
        </a>
        <!-- Centre FAB: Buy -->
        <div class="kx-bnav-item kx-bnav-center">
            <a href="<?php echo e(Auth::user()->kyc_verified ? url('/buy') : url('/kyc')); ?>"
               class="kx-bnav-center-btn" title="Buy Crypto">
                <i class="bi bi-arrow-down-circle-fill"></i>
            </a>
            <span class="kx-bnav-center-lbl">Buy</span>
        </div>
        <a href="<?php echo e(url('/sell')); ?>"
           class="kx-bnav-item <?php if(request()->is('sell*')): ?> kx-bnav-active <?php endif; ?>">
            <i class="bi bi-arrow-up-circle-fill"></i><span>Sell</span>
        </a>
        <a href="<?php echo e(url('/settings')); ?>"
           class="kx-bnav-item <?php if(request()->is('settings*')): ?> kx-bnav-active <?php endif; ?>">
...
</html><?php /**PATH C:\xampp\htdocs\kayxchangev2\resources\views\layout.blade.php ENDPATH**/ ?>