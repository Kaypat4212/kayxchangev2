...
<body style="font-family: Arial, sans-serif; line-height: 1.6; color: #333;">
    <div style="max-width: 600px; margin: 0 auto; padding: 20px;">
        ...
        <p>Dear <?php echo e($deposit->user->name); ?>,</p>
        ...
        <div style="background-color: #f8f9fa; padding: 20px; border-left: 4px solid #28a745; margin: 20px 0;">
            ...
            <p><strong>Transaction Reference:</strong> <?php echo e($deposit->transaction_reference ?? 'N/A'); ?></p>
            <p><strong>Payment Method:</strong> <?php echo e(ucfirst($deposit->payment_method)); ?></p>
            <p><strong>Status:</strong> <span style="color: #28a745; font-weight: bold;">Approved</span></p>
            <p><strong>Date:</strong> <?php echo e($deposit->created_at->format('F j, Y \a\t g:i A')); ?></p>
        </div>
...
</html><?php /**PATH C:\xampp\htdocs\kayxchangev2\resources\views\emails\deposit_approved.blade.php ENDPATH**/ ?>