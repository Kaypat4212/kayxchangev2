...
<?php $__env->startSection('content'); ?>
    <?php $balance = auth()->user()?->balance ?? 0; ?>
...
<div class="col-xl-5 col-lg-6 col-md-8">
    ...
    <form method="POST" action="<?php echo e(route('buy.submit')); ?>" id="buyForm">
        <?php echo csrf_field(); ?>
        ...
        <div id="step2" class="d-none">
            ...
            <div class="mb-3">
                ...
                <input type="text" name="wallet_address" id="wallet_address"
                    class="form-control kx-input <?php $__errorArgs = ['wallet_address'];
...
unset($__errorArgs, $__bag); ?>
            ...
            <div class="mb-3">
                ...
                <select name="network" id="network"
                    class="form-select kx-input <?php $__errorArgs = ['network'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> border-danger <?php unset($message);
...
(function() {
    ...
    document.addEventListener('DOMContentLoaded', function() {
        ...
        <?php endif; ?>
        var errs = <?php echo json_encode($errors->all(), 15, 512) ?>;
...
<?php echo $__env->make('buylayout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\kayxchangev2\resources\views\buy.blade.php ENDPATH**/ ?>