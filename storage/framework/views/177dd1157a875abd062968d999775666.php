...
<div class="container-fluid py-3 px-3 px-md-4">
    <div class="kx-page-header">
        <div>
            ...
            <small>Editing: <?php echo e($user->name); ?></small>
        </div>
        <div class="d-flex gap-2">
            <a href="<?php echo e(route('admin.users.show', $user->id)); ?>" class="btn-kx-outline"><i class="bi bi-eye me-1"></i>View</a>
            <a href="<?php echo e(route('admin.users.index')); ?>" class="btn-kx-outline"><i class="bi bi-arrow-left me-1"></i>Back</a>
        </div>
    </div>
    ...
    <div class="row g-3">
        <div class="col-lg-7">
            ...
            <div class="kx-panel">
                ...
                <form action="<?php echo e(route('admin.users.update', $user->id)); ?>" method="POST" style="padding:1.25rem">
                    <?php echo csrf_field(); ?> <?php echo method_field('PUT'); ?>
                    <div class="row g-3">
                        <div class="col-md-6">
                            <label class="kx-label">Name</label>
                            <input type="text" name="name" class="form-control kx-input" value="<?php echo e(old('name', $user->name)); ?>" required>
                            <?php $__errorArgs = ['name'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?><div style="color:var(--kx-red);font-size:.75rem;margin-top:.3rem"><?php echo e($message); ?></div><?php unset($message);
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="email" name="email" class="form-control kx-input" value="<?php echo e(old('email', $user->email)); ?>" required>
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="number" name="balance" class="form-control kx-input" step="0.01" min="0" value="<?php echo e(old('balance', $user->balance ?? 0)); ?>" required>
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="mt-3 d-flex gap-2">
                        ...
                        <a href="<?php echo e(route('admin.users.index')); ?>" class="btn-kx-outline">Cancel</a>
                    </div>
                </form>
            </div>
            ...
            <div class="kx-panel">
                <div class="kx-panel-header"><span class="kx-panel-title"><i class="bi bi-wallet2 me-2" style="color:var(--kx-yellow)"></i>Adjust Balance</span>
                    <span style="font-size:.8rem;color:var(--kx-green);font-weight:600">Current: ₦<?php echo e(number_format($user->balance ?? 0, 2)); ?></span>
                </div>
                <form action="<?php echo e(route('admin.users.balance.adjust', $user->id)); ?>" method="POST" style="padding:1.25rem">
            ...
            <div class="kx-panel">
                ...
                <div style="padding:1.25rem">
                    <div style="display:flex;align-items:center;gap:.75rem;margin-bottom:1rem">
                        ...
                        <div>
                            <div style="font-weight:600;color:#fff"><?php echo e($user->name); ?></div>
                            <div style="font-size:.75rem;color:var(--kx-muted)">ID #<?php echo e($user->id); ?></div>
                        </div>
                    </div>
                    <div style="font-size:.8rem;color:var(--kx-muted);display:flex;flex-direction:column;gap:.5rem">
                        <div><i class="bi bi-envelope me-2"></i><?php echo e($user->email); ?></div>
                        <div><i class="bi bi-calendar me-2"></i>Joined <?php echo e($user->created_at->format('d M Y')); ?></div>
                        <div><i class="bi bi-clock me-2"></i>Updated <?php echo e($user->updated_at->diffForHumans()); ?></div>
                    </div>
                    <div class="mt-3">
                        <a href="<?php echo e(route('admin.users.backdoor', $user->id)); ?>"
...
<?php echo $__env->make('adminnavlayout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\kayxchangev2\resources\views\admin\users\edit.blade.php ENDPATH**/ ?>