...
<div class="container-fluid py-3 px-3 px-md-4">
    ...
    <div class="kx-stat-row">
        <div class="kx-stat"><div class="kx-stat-icon icon-blue"><i class="bi bi-bell"></i></div>
            <div><div class="kx-stat-label">Total</div><div class="kx-stat-value"><?php echo e($stats['total']); ?></div></div></div>
        <div class="kx-stat"><div class="kx-stat-icon icon-yellow"><i class="bi bi-envelope-fill"></i></div>
            <div><div class="kx-stat-label">Unread</div><div class="kx-stat-value"><?php echo e($stats['unread']); ?></div></div></div>
        <div class="kx-stat"><div class="kx-stat-icon icon-purple"><i class="bi bi-broadcast"></i></div>
            <div><div class="kx-stat-label">Broadcast</div><div class="kx-stat-value"><?php echo e($stats['broadcast']); ?></div></div></div>
        <div class="kx-stat"><div class="kx-stat-icon icon-green"><i class="bi bi-calendar-check"></i></div>
            <div><div class="kx-stat-label">Today</div><div class="kx-stat-value"><?php echo e($stats['today']); ?></div></div></div>
    </div>
    ...
    <div class="kx-panel">
        ...
        <div class="kx-table-wrap">
            <table class="kx-table">
                ...
                <tbody>
                <?php $list = $notifications->items() ?? []; ?>
                <?php $__empty_1 = true; $__currentLoopData = $list; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $n): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                <tr>
                    <td style="color:var(--kx-muted)">#<?php echo e($n->id); ?></td>
                    <td>
                        <span style="font-weight:600"><?php echo e($n->title); ?></span>
                        <?php if(!($n->is_read ?? true)): ?>
                            <span class="kx-badge kx-badge-yellow ms-1" style="font-size:.62rem">Unread</span>
                        <?php endif; ?>
                    </td>
                    <td style="max-width:240px;font-size:.78rem;color:var(--kx-muted)"><?php echo e(Str::limit($n->message, 70)); ?></td>
                    <td>
                        <?php if($n->is_broadcast ?? false): ?>
                    ...
                    <td style="font-size:.78rem"><?php echo e(isset($n->user) ? $n->user->name : 'All Users'); ?></td>
                    <td style="font-size:.75rem;color:var(--kx-muted)"><?php echo e($n->created_at ? $n->created_at->diffForHumans() : '—'); ?></td>
                    <td>
                        <div class="d-flex gap-1">
                            <form action="<?php echo e(route('admin.notifications.delete', $n->id)); ?>" method="POST" style="display:inline" onsubmit="return confirm('Delete this notification?')">
...
async function aiGenerateNotifCopy(){
    ...
    try {
        const res  = await fetch('<?php echo e(route("ai.notification-copy")); ?>', {
            method: 'POST',
...
<?php echo $__env->make('adminnavlayout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\kayxchangev2\resources\views/admin/notifications/index.blade.php ENDPATH**/ ?>