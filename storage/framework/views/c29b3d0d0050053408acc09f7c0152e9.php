  ...
  <tr>
    <td style="background:#161b27;padding:32px 40px;border:1px solid rgba(255,255,255,0.07);border-top:none;border-bottom:none;">
      ...
      <p style="color:#7a8599;font-size:14px;margin:0 0 24px;">
        Someone tried to log into your KayXchange account with the email <strong style="color:#e4e8f0;"><?php echo e($log->email); ?></strong> but the attempt failed.
      </p>
      ...
      <div style="background:#1e2535;border:1px solid rgba(239,68,68,0.2);border-radius:12px;padding:20px 24px;margin-bottom:24px;">
        <table width="100%" cellpadding="0" cellspacing="0">
          <tr>
            ...
            <td style="font-size:13px;color:#e4e8f0;font-weight:600;text-align:right;padding-bottom:10px;"><?php echo e($log->created_at->format('d M Y, g:i A')); ?></td>
          </tr>
          <tr>
            <td style="font-size:13px;color:#7a8599;padding-bottom:10px;">IP Address</td>
            <td style="font-size:13px;color:#ef4444;font-weight:600;text-align:right;padding-bottom:10px;"><?php echo e($log->ip_address ?? 'Unknown'); ?></td>
          </tr>
          <tr>
            <td style="font-size:13px;color:#7a8599;">Browser / Device</td>
            <td style="font-size:13px;color:#e4e8f0;font-weight:600;text-align:right;"><?php echo e(Str::limit($log->user_agent ?? 'Unknown', 50)); ?></td>
          </tr>
        </table>
      </div>
      ...
      <div style="text-align:center;margin:24px 0;">
        <a href="<?php echo e(url('/settings/change-password')); ?>"
  ...
  <tr>
    <td style="background:#0d1117;border:1px solid rgba(255,255,255,0.07);border-top:none;border-radius:0 0 16px 16px;padding:18px 40px;text-align:center;">
      <p style="color:#7a8599;font-size:12px;margin:0;">
        © <?php echo e(date('Y')); ?> KayXchange. This is an automated security notification.
      </p>
    </td>
  </tr>
...
<?php /**PATH C:\xampp\htdocs\kayxchangev2\resources\views\emails\login_failed.blade.php ENDPATH**/ ?>