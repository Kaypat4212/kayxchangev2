...
<div class="col-xl-5 col-lg-6">
    ...
    <div class="kx-trade-card">
        <div class="kx-trade-top">
            <div>
                ...
                <div class="ref"><?php echo e($trade->transaction_ref); ?></div>
            </div>
        ...
        <div class="kx-trade-amounts">
            <div class="kx-amt-side">
                ...
                <div class="kx-amt-value"><?php echo e($trade->coin); ?></div>
                <div class="kx-amt-sub">$<?php echo e(number_format($trade->usd_amount, 2)); ?></div>
            </div>
            <div class="kx-amt-arrow"><i class="bi bi-arrow-right"></i></div>
            <div class="kx-amt-side">
                <div class="kx-amt-label">You Get</div>
                <div class="kx-amt-value green">₦<?php echo e(number_format($trade->naira_amount, 2)); ?></div>
    ...
    <div class="d-flex flex-column gap-3 kx-actions-anim" style="margin-bottom:2rem;">
        <a href="<?php echo e(route('dashboard')); ?>" class="kx-btn kx-btn-primary">
            <i class="bi bi-house-fill"></i> Back to Dashboard
        </a>
        <a href="<?php echo e(route('transactions.history')); ?>" class="kx-btn kx-btn-outline">
...
<?php echo $__env->make('selllayout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\kayxchangev2\resources\views\sell\success.blade.php ENDPATH**/ ?>