...
<?php $hasPin = (bool) auth()->user()->transaction_pin; ?>

<div class="chpin-page">
    <div class="mb-4">
        <h1 style="font-size:1.3rem;font-weight:700;color:#fff;margin-bottom:.2rem">
            <?php echo e($hasPin ? 'Change PIN' : 'Set Up PIN'); ?>

        </h1>
        <p style="font-size:.82rem;color:rgba(255,255,255,.4)">
            <?php echo e($hasPin ? 'Update your 4-digit transaction security PIN.' : 'Create a 4-digit PIN to secure your transactions.'); ?>
    ...
    <div class="chpin-card">
        ...
        <div class="chpin-step-indicator">
            <?php if($hasPin): ?><div class="chpin-step-pip" id="cpPip0" style="width:48px"></div><?php endif; ?>
            <div class="chpin-step-pip" id="cpPip<?php echo e($hasPin ? 1 : 0); ?>" style="width:48px"></div>
            <div class="chpin-step-pip" id="cpPip<?php echo e($hasPin ? 2 : 1); ?>" style="width:48px"></div>
        </div>

        <!-- Step label -->
        <span class="chpin-label" id="cpStepLabel">
            <?php if($hasPin): ?>Enter current PIN@else Enter new PIN@endif
        </span>
        ...
        <form method="POST" action="<?php echo e(route('pin.change')); ?>" id="cpForm">
            <?php echo csrf_field(); ?>
            <?php if($hasPin): ?><input type="hidden" name="current_pin" id="cpCurrentInput"><?php endif; ?>
            ...
            <button type="submit" class="chpin-btn" id="cpSubmitBtn">
                ...
                <?php echo e($hasPin ? 'Change PIN' : 'Set PIN'); ?>
...
<script>
(function(){
    const HAS_PIN = <?php echo e($hasPin ? 'true' : 'false'); ?>;
...
<?php echo $__env->make('selllayout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\kayxchangev2\resources\views\pin\change.blade.php ENDPATH**/ ?>