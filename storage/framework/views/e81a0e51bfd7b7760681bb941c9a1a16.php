...
<div class="container-xl">
    ...
    <div class="env-alert"><i class="bi bi-check-circle-fill me-2"></i><?php echo e(session('success')); ?></div>
    <?php endif; ?>
    <?php if($errors->any()): ?>
    <div class="env-alert error"><i class="bi bi-x-circle-fill me-2"></i><?php echo e($errors->first()); ?></div>
    <?php endif; ?>
    ...
    <div class="env-card mb-4" style="--env-accent:#00cc00;">
        ...
        <div class="pm-toggle-grid" id="pm-toggle-grid">
            ...
            <?php $__currentLoopData = $pmCards; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $pmKey => $pmMeta): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <?php
                $isOn      = $enabledMethods[$pmKey] ?? true;
                $hasKeys   = $keysConfigured[$pmKey] ?? true;
                $isVisible = $isOn && $hasKeys; // actually shown to users
            ?>
            <div class="pm-toggle-card <?php echo e($isVisible ? 'pm-on' : 'pm-off'); ?> <?php echo e(!$hasKeys ? 'pm-locked' : ''); ?>" id="pm-card-<?php echo e($pmKey); ?>">
                <div class="pm-tc-left">
                    <div class="pm-tc-icon" style="background:<?php echo e($pmMeta['bg']); ?>;border-color:<?php echo e($pmMeta['border']); ?>">
                        <i class="bi <?php echo e($pmMeta['icon']); ?>" style="color:<?php echo e($pmMeta['color']); ?>;"></i>
                    </div>
                    <div>
                        <div class="pm-tc-name"><?php echo e($pmMeta['label']); ?></div>
                        <div class="pm-tc-status <?php echo e($isVisible ? 'on' : 'off'); ?>" id="pm-status-<?php echo e($pmKey); ?>">
                            <?php if(!$hasKeys): ?>
                ...
                <label class="pm-switch <?php echo e(!$hasKeys ? 'pm-switch-disabled' : ''); ?>" title="<?php echo e(!$hasKeys ? 'Add API keys first to enable this method' : 'Toggle '.$pmMeta['label']); ?>">
                    <input type="checkbox" class="pm-toggle-input"
                           data-method="<?php echo e($pmKey); ?>"
                           <?php echo e($isOn ? 'checked' : ''); ?>

                           <?php echo e(!$hasKeys ? 'disabled' : ''); ?>>
    ...
    <form method="POST" action="<?php echo e(route('admin.env.update')); ?>" id="envForm">
        <?php echo csrf_field(); ?>
        ...
        <?php $meta = $groupMeta[$groupKey] ?? ['label' => ucfirst($groupKey), 'icon' => 'bi-key', 'color' => '#00cc00']; ?>
        <div class="env-card" style="--env-accent:<?php echo e($meta['color']); ?>">
            <div class="env-group-label" style="color:<?php echo e($meta['color']); ?>">
                ...
                <div class="col-md-6">
                    <div class="env-field">
                        <div class="env-label">
                            ...
                            <span class="env-key"><?php echo e($field['key']); ?></span>
                        </div>
                        <div class="env-input-wrap">
                            <input
                                type="<?php echo e($field['type'] === 'password' ? 'password' : ($field['type'] === 'email' ? 'email' : ($field['type'] === 'url' ? 'url' : 'text'))); ?>"
                                name="env[<?php echo e($field['key']); ?>]"
                                value="<?php echo e(old('env.'.$field['key'], $field['value'])); ?>"
                                class="env-input"
                                autocomplete="off"
                                data-type="<?php echo e($field['type']); ?>"
                                id="field_<?php echo e($field['key']); ?>"
                            >
            ...
            <div style="margin-top:16px">
                ...
                <div class="env-guide d-none mt-2">
                    ...
                    <code style="color:#c4b5fd"><?php echo e(url('/deposits/webhook/korapay')); ?></code><br><br>
            ...
            <div style="margin-top:16px">
                ...
                <div class="env-guide d-none mt-2" style="border-color:rgba(0,204,0,.2);background:rgba(0,204,0,.05)">
                    ...
                    <code style="color:#86efac"><?php echo e(url('/deposits/webhook/paystack')); ?></code>
                </div>
            </div>
            <?php endif; ?>

            
            <?php if($groupKey === 'flutterwave'): ?>
            <div style="margin-top:16px">
                ...
                <div class="env-guide d-none mt-2" style="border-color:rgba(251,191,36,.2);background:rgba(251,191,36,.05)">
                    ...
                    <code style="color:#fde68a"><?php echo e(url('/deposits/webhook/flutterwave')); ?></code><br>
...
(function(){
    ...
    document.querySelectorAll('.pm-toggle-input').forEach(function(input) {
        input.addEventListener('change', function() {
            ...
            // AJAX call
            fetch('<?php echo e(route("admin.env.toggle-pm")); ?>', {
                method: 'POST',
                headers: {
...
<?php echo $__env->make('adminnavlayout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\kayxchangev2\resources\views\admin\env-editor.blade.php ENDPATH**/ ?>