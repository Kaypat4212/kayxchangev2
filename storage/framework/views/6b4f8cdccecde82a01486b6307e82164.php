...
<?php $__env->startSection('title', 'FAQs — KayXchange'); ?>
...
<div class="faq-wrap">
    ...
    <div class="faq-group" data-cat="account">
        ...
        <div class="faq-item">
            ...
            <div class="faq-a"><div class="faq-a-inner">
                Visit our <a href="<?php echo e(url('/register')); ?>">registration page</a>, enter your name, email address, and a strong password. After signing up, complete your email verification and KYC to unlock all features.
            </div></div>
        </div>
        ...
        <div class="faq-item">
            ...
            <div class="faq-a"><div class="faq-a-inner">
                Click <a href="<?php echo e(url('/forgot-password')); ?>">Forgot Password</a> on the login page, enter your registered email address, and follow the reset link sent to your inbox. Check your spam folder if the email doesn't arrive within a few minutes.
            </div></div>
        </div>
    ...
    <div class="faq-group" data-cat="security">
        ...
        <div class="faq-item">
            ...
            <div class="faq-a"><div class="faq-a-inner">
                Immediately <a href="<?php echo e(url('/forgot-password')); ?>">reset your password</a> and contact our support team. Provide as much detail as possible so we can investigate and secure your account.
            </div></div>
        </div>
    </div>
    ...
    <div class="faq-cta">
        ...
        <a href="<?php echo e(url('/contact')); ?>" class="btn-kx-green">
...
<?php echo $__env->make('layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\kayxchangev2\resources\views\faqs.blade.php ENDPATH**/ ?>