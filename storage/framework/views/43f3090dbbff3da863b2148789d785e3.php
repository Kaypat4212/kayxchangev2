...
<div class="row justify-content-center">
    <div class="col-lg-7 col-xl-6">
        ...
        <div class="kx-steps">
            ...
            <div class="kx-step <?php echo e($existingKyc ? 'done' : 'active'); ?>">
                <div class="kx-step-num">
                    <?php if($existingKyc): ?><i class="bi bi-check-lg"></i><?php else: ?> 2 <?php endif; ?>
                </div>
                <span class="kx-step-label">Documents</span>
            </div>
            <div class="kx-step <?php echo e(($existingKyc && $existingKyc->status === 'approved') ? 'done' : (($existingKyc && $existingKyc->status === 'pending') ? 'active' : '')); ?>">
                <div class="kx-step-num">
                    <?php if($existingKyc && $existingKyc->status === 'approved'): ?><i class="bi bi-check-lg"></i><?php else: ?> 3 <?php endif; ?>
                </div>
        ...
        <?php if($existingKyc): ?>
            <?php if($existingKyc->status === 'pending'): ?>
            ...
            <?php elseif($existingKyc->status === 'approved'): ?>
            ...
            <?php elseif($existingKyc->status === 'rejected'): ?>
        ...
        <?php if(!$existingKyc || $existingKyc->status === 'rejected'): ?>
        ...
        <form method="POST" action="<?php echo e(route('kyc.submit')); ?>" enctype="multipart/form-data" id="kycForm">
            <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>
        ...
        <?php elseif($existingKyc && $existingKyc->status === 'approved'): ?>
        ...
        <div class="kx-kyc-card">
            <div class="kx-kyc-card-body text-center py-4">
                ...
                <div class="d-flex gap-3 justify-content-center flex-wrap">
                    <a href="<?php echo e(route('buy')); ?>" class="kx-submit-btn" style="width:auto;padding:.7rem 1.75rem;">
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('kyclayout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\kayxchangev2\resources\views\kyc\form.blade.php ENDPATH**/ ?>