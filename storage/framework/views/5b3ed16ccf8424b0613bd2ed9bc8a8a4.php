...
<div class="setup-page">
    ...
    <?php if(session('info')): ?>
    <div class="sp-notice">&#x2139;&#xFE0F; <?php echo e(session('info')); ?></div>
    <?php endif; ?>
    ...
    <div class="setup-card">
        ...
        <form method="POST" action="<?php echo e(route('pin.setup')); ?>" id="spForm">
            <?php echo csrf_field(); ?>
...
<?php echo $__env->make('selllayout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\kayxchangev2\resources\views\pin\setup.blade.php ENDPATH**/ ?>