...
<div class="container-fluid px-3 px-md-4 py-3">
    ...
    <div class="kx-welcome rounded-3 mb-4">
        <div class="d-flex align-items-center justify-content-between flex-wrap gap-2">
            ...
            <span class="kx-badge <?php echo e($isProduction ? 'kx-badge-green' : 'kx-badge-amber'); ?>">
                <span class="kx-dot <?php echo e($isProduction ? 'kx-dot-green' : 'kx-dot-amber'); ?>"></span>
                <?php echo e($isProduction ? 'Production Mode' : 'Development Mode'); ?>

            </span>
            <a href="<?php echo e(route('admin.telegram.ai-config')); ?>" class="kx-btn" style="background:rgba(168,85,247,0.15);color:#a855f7;border:1px solid rgba(168,85,247,0.3);padding:7px 14px;font-size:0.82rem;">
                🤖 AI Bot Config
            </a>
        </div>
    </div>
    ...
    <?php if(session('success')): ?>
        <div class="kx-alert kx-alert-success"><i class="bi bi-check-circle me-2"></i><?php echo e(session('success')); ?></div>
    <?php endif; ?>
    <?php if(session('error')): ?>
        <div class="kx-alert kx-alert-error"><i class="bi bi-exclamation-circle me-2"></i><?php echo e(session('error')); ?></div>
    <?php endif; ?>
        ...
        <div class="col-lg-8">
            ...
            <div class="kx-panel">
                ...
                <div class="kx-panel-body">
                    <div class="kx-stat-grid mb-3">
                        <div class="kx-stat">
                            <div class="kx-stat-val" style="color:var(--kx-tg)"><?php echo e($totalVerified); ?></div>
                            <div class="kx-stat-label">Verified Users</div>
                        </div>
                        <div class="kx-stat">
                            <div class="kx-stat-val" style="color:var(--kx-green)"><?php echo e($totalWithNotifications); ?></div>
                            <div class="kx-stat-label">Notifications On</div>
                        </div>
                        <div class="kx-stat">
                            <div class="kx-stat-val" style="color:var(--kx-warning)">
                                <?php echo e($totalVerified - $totalWithNotifications); ?>
                    ...
                    <?php if(!empty($botInfo['result'])): ?>
                    <div class="kx-status-row">
                        <span class="kx-dot kx-dot-green"></span>
                        <span><strong>Bot:</strong> <?php echo e($botInfo['result']['first_name']); ?></span>
                        <span class="ms-auto text-muted">{{ $botInfo['result']['username'] }}</span>
                    </div>
                    <?php endif; ?>

                    <div class="kx-status-row">
                        <span class="kx-dot <?php echo e(!empty($webhookInfo['url']) ? 'kx-dot-green' : 'kx-dot-amber'); ?>"></span>
                        <span><strong>Webhook:</strong>
                            <?php if(!empty($webhookInfo['url'])): ?>
                                <span class="kx-badge kx-badge-green ms-1">Active</span>
                                <span class="text-muted ms-2" style="font-size:0.78rem;word-break:break-all"><?php echo e($webhookInfo['url']); ?></span>
                            <?php else: ?>
                    ...
                    <?php if(!empty($webhookInfo['pending_update_count']) && $webhookInfo['pending_update_count'] > 0): ?>
                    <div class="kx-status-row">
                        <span class="kx-dot kx-dot-amber"></span>
                        <span><strong>Pending updates:</strong> <?php echo e($webhookInfo['pending_update_count']); ?></span>
                    </div>
                    <?php endif; ?>
            ...
            <div class="kx-panel">
                ...
                <div class="kx-panel-body">
                    ...
                    <div class="d-flex gap-2 flex-wrap">
                        <form method="POST" action="<?php echo e(route('admin.telegram.set-webhook')); ?>">
                            <?php echo csrf_field(); ?>
                            <button type="submit" class="kx-btn kx-btn-tg">
                                <i class="bi bi-link-45deg"></i> Set Webhook
                                <span style="font-size:0.72rem;opacity:0.8">(<?php echo e(rtrim(config('app.url'),'/')); ?>/api/telegram/webhook)</span>
                            </button>
                        </form>
                        <form method="POST" action="<?php echo e(route('admin.telegram.delete-webhook')); ?>">
                            <?php echo csrf_field(); ?>
            ...
            <div class="kx-panel">
                <div class="kx-panel-header">
                    ...
                    <span class="kx-badge kx-badge-blue"><?php echo e($totalWithNotifications); ?> recipients</span>
                </div>
                <div class="kx-panel-body">
                    <p style="color:var(--kx-muted);font-size:0.83rem">
                        Sends to all verified users with notifications enabled. Supports *bold*, _italic_, and `code` (Markdown).
                    </p>
                    <form method="POST" action="<?php echo e(route('admin.telegram.broadcast')); ?>">
                        <?php echo csrf_field(); ?>
...
$message = $__bag->first($__errorArgs[0]); ?>
                            <div class="kx-alert kx-alert-error mb-2"><?php echo e($message); ?></div>
                        <?php unset($message);
if (isset($__messageOriginal)) { $message = $__messageOriginal; }
endif;
unset($__errorArgs, $__bag); ?>
                        <button type="submit" class="kx-btn kx-btn-tg"
                            onclick="return confirm('Send this message to <?php echo e($totalWithNotifications); ?> users?')">
            ...
            <div class="kx-panel">
                ...
                <div class="kx-panel-body">
                    <form method="POST" action="<?php echo e(route('admin.telegram.send-direct')); ?>">
                        <?php echo csrf_field(); ?>
                        <div class="mb-3">
                            ...
                            <select name="user_id" class="kx-select" required>
                                ...
                                <?php $__currentLoopData = $recentlyLinked; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $u): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <option value="<?php echo e($u->id); ?>"><?php echo e($u->name); ?> (<?php echo e($u->email); ?>)
                                        <?php if($u->telegram_username): ?> — {{ $u->telegram_username }} <?php endif; ?>
                                    </option>
        ...
        <div class="col-lg-4">
            ...
            <div class="kx-panel">
                ...
                <div class="kx-panel-body">
                    <div class="kx-status-row">
                        ...
                        <span style="word-break:break-all;font-size:0.78rem"><?php echo e(config('app.url')); ?></span>
                    </div>
                    <div class="kx-status-row">
                        <span style="color:var(--kx-muted);width:130px;flex-shrink:0">Bot Token</span>
                        <span class="kx-badge kx-badge-<?php echo e(env('KAYXCHANGE_TELEGRAM_BOT_TOKEN') ? 'green' : 'red'); ?>">
                            <?php echo e(env('KAYXCHANGE_TELEGRAM_BOT_TOKEN') ? 'Set ✓' : 'Missing ✗'); ?>

                        </span>
                    </div>
                    <div class="kx-status-row">
                        <span style="color:var(--kx-muted);width:130px;flex-shrink:0">Secure Cookie</span>
                        <span class="kx-badge kx-badge-<?php echo e(env('SESSION_SECURE_COOKIE') ? 'green' : 'amber'); ?>">
                            <?php echo e(env('SESSION_SECURE_COOKIE') ? 'Yes' : 'No (local ok)'); ?>

                        </span>
                    </div>
                    <div class="kx-status-row">
                        <span style="color:var(--kx-muted);width:130px;flex-shrink:0">Session Domain</span>
                        <span style="font-size:0.78rem"><?php echo e(env('SESSION_DOMAIN') ?: '(not set)'); ?></span>
                    </div>
                    <div class="mt-3">
                        <a href="<?php echo e(url('/admin/env-editor')); ?>" class="kx-btn kx-btn-outline w-100 justify-content-center">
            ...
            <div class="kx-panel">
                <div class="kx-panel-header">
                    ...
                    <span class="kx-badge kx-badge-blue"><?php echo e($totalVerified); ?> total</span>
                </div>
                <div class="kx-panel-body p-0">
                    <?php if($recentlyLinked->isEmpty()): ?>
                    ...
                    <table class="kx-table">
                        ...
                        <tbody>
                            ...
                            <tr>
                                <td>
                                    <div style="font-weight:600;font-size:0.82rem"><?php echo e(Str::limit($u->name, 18)); ?></div>
                                    <div style="color:var(--kx-muted);font-size:0.74rem">
                                        <?php if($u->telegram_username): ?>{{ $u->telegram_username }}<?php endif; ?>
                                    </div>
                                </td>
                                <td>
                                    <span class="kx-badge <?php echo e($u->telegram_notifications ? 'kx-badge-green' : 'kx-badge-red'); ?>">
                                        <?php echo e($u->telegram_notifications ? 'On' : 'Off'); ?>

                                    </span>
                                </td>
                                <td>
                                    <form method="POST" action="<?php echo e(route('admin.telegram.unlink-user')); ?>" class="d-inline">
                                        <?php echo csrf_field(); ?>
                                        <input type="hidden" name="user_id" value="<?php echo e($u->id); ?>">
                                        <button type="submit" class="kx-btn kx-btn-danger kx-btn-sm"
                                            onclick="return confirm('Unlink Telegram for <?php echo e(addslashes($u->name)); ?>?')"
                                            title="Unlink">
...
<?php echo $__env->make('adminnavlayout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\kayxchangev2\resources\views\admin\telegram.blade.php ENDPATH**/ ?>