...
<div class="ref-wrap">
    ...
    <?php if(session('success')): ?>
        <div class="alert alert-success" style="font-size:.82rem"><?php echo e(session('success')); ?></div>
    <?php endif; ?>
    ...
    <div class="row g-3">
        <div class="col-lg-5">
            <div class="ref-panel">
                ...
                <div class="bd">
                    <form method="POST" action="<?php echo e(route('admin.referrals.defaults.update')); ?>">
                        <?php echo csrf_field(); ?>
                        <?php echo method_field('PUT'); ?>
                        <div class="mb-3">
                            <label class="form-label text-light" style="font-size:.8rem">Referrer Reward (NGN)</label>
                            <input type="number" step="0.01" min="0" name="referral_reward_amount" value="<?php echo e(old('referral_reward_amount', $defaultReward)); ?>" class="form-control ref-input" required>
                        ...
                        <div class="mb-3">
                            ...
                            <input type="number" step="0.01" min="0" name="special_referral_signup_bonus" value="<?php echo e(old('special_referral_signup_bonus', $defaultSignupBonus)); ?>" class="form-control ref-input" required>
            ...
            <div class="ref-panel">
                ...
                <div class="bd">
                    <form method="POST" action="<?php echo e(route('admin.referrals.codes.store')); ?>">
                        <?php echo csrf_field(); ?>
                        <div class="mb-2">
                        ...
                        <div class="row g-2 mb-2">
                            <div class="col-6">
                                ...
                                <input type="number" step="0.01" min="0" name="signup_bonus" value="<?php echo e($defaultSignupBonus); ?>" class="form-control ref-input" required>
                            </div>
                            <div class="col-6">
                                <label class="form-label text-light" style="font-size:.8rem">Referrer Reward (NGN)</label>
                ...
                <div class="bd ref-scroll">
                    <table class="ref-table">
                        ...
                        <?php $__empty_1 = true; $__currentLoopData = $codes; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $code): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                            <tr>
                                <td>
                                    <div class="ref-code"><?php echo e($code->code); ?></div>
                                    <div class="ref-muted"><?php echo e($code->label ?: 'No label'); ?></div>
                                </td>
                                <td><?php echo e(ucfirst($code->category)); ?></td>
                                <td>
                                    <?php if($code->owner): ?>
                                        <?php echo e($code->owner->name); ?>

                                        <div class="ref-muted"><?php echo e($code->owner->email); ?></div>
                                    <?php else: ?>
                                        <span class="ref-muted">No owner</span>
                                    <?php endif; ?>
                                </td>
                                <td>
                                    <?php if($code->referrer_reward !== null): ?>
                                        ₦<?php echo e(number_format((float) $code->referrer_reward, 2)); ?>

                                    <?php else: ?>
                                        <span class="ref-muted">Default (₦<?php echo e(number_format($defaultReward, 2)); ?>)</span>
                                    <?php endif; ?>
                                </td>
                                <td>₦<?php echo e(number_format((float) $code->signup_bonus, 2)); ?></td>
                                <td>
                                    <span class="ref-pill <?php echo e($code->is_active ? 'active' : 'inactive'); ?>"><?php echo e($code->is_active ? 'Active' : 'Inactive'); ?></span>
                                </td>
                                <td>
                                    <button class="ref-btn-outline" type="button" data-bs-toggle="collapse" data-bs-target="#edit-code-<?php echo e($code->id); ?>">
                                        <i class="bi bi-pencil-square"></i>
                                    </button>
                                    <form method="POST" action="<?php echo e(route('admin.referrals.codes.destroy', $code)); ?>" class="d-inline">
                                        <?php echo csrf_field(); ?>
                            ...
                            <tr class="collapse" id="edit-code-<?php echo e($code->id); ?>">
                                <td colspan="7" style="background:rgba(255,255,255,0.02)">
                                    <form method="POST" action="<?php echo e(route('admin.referrals.codes.update', $code)); ?>" class="row g-2 align-items-end">
                                        <?php echo csrf_field(); ?>
                                        <?php echo method_field('PUT'); ?>
                                        <div class="col-md-2">
                                            <label class="form-label text-light" style="font-size:.75rem">Code</label>
                                            <input class="form-control ref-input" name="code" value="<?php echo e($code->code); ?>" required>
                                        </div>
                                        <div class="col-md-2">
                                            <label class="form-label text-light" style="font-size:.75rem">Category</label>
                                            <select class="form-select ref-select" name="category" required>
                                                <option value="ambassador" <?php echo e($code->category === 'ambassador' ? 'selected' : ''); ?>>Ambassador</option>
                                                <option value="influencer" <?php echo e($code->category === 'influencer' ? 'selected' : ''); ?>>Influencer</option>
                                                <option value="partner" <?php echo e($code->category === 'partner' ? 'selected' : ''); ?>>Partner</option>
                                            </select>
                                        </div>
                                        <div class="col-md-2">
                                            ...
                                            <select class="form-select ref-select" name="owner_user_id">
                                                ...
                                                <?php $__currentLoopData = $users; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $owner): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                    <option value="<?php echo e($owner->id); ?>" <?php echo e((int) $code->owner_user_id === (int) $owner->id ? 'selected' : ''); ?>><?php echo e($owner->name); ?></option>
                                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                            </select>
                                        </div>
                                        <div class="col-md-2">
                                            <label class="form-label text-light" style="font-size:.75rem">Referrer Reward</label>
                                            <input class="form-control ref-input" type="number" step="0.01" min="0" name="referrer_reward" value="<?php echo e($code->referrer_reward); ?>">
                                        </div>
                                        <div class="col-md-2">
                                            <label class="form-label text-light" style="font-size:.75rem">Signup Bonus</label>
                                            <input class="form-control ref-input" type="number" step="0.01" min="0" name="signup_bonus" value="<?php echo e($code->signup_bonus); ?>" required>
                                        </div>
                                        <div class="col-md-2">
                                            <label class="form-label text-light" style="font-size:.75rem">Active</label>
                                            <select class="form-select ref-select" name="is_active">
                                                <option value="1" <?php echo e($code->is_active ? 'selected' : ''); ?>>Yes</option>
                                                <option value="0" <?php echo e(!$code->is_active ? 'selected' : ''); ?>>No</option>
                                            </select>
                                        </div>
                                        <div class="col-12">
                                            <label class="form-label text-light" style="font-size:.75rem">Label</label>
                                            <input class="form-control ref-input" name="label" value="<?php echo e($code->label); ?>">
                                        </div>
                                        <div class="col-12">
                                            <label class="form-label text-light" style="font-size:.75rem">Notes</label>
                                            <textarea class="form-control ref-textarea" name="notes" rows="2"><?php echo e($code->notes); ?></textarea>
                                        </div>
                                        <div class="col-12">
...
<?php echo $__env->make('adminnavlayout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\kayxchangev2\resources\views\admin\referrals\settings.blade.php ENDPATH**/ ?>