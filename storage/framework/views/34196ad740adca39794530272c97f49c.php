  ...
  <tr>
    <td style="background:#161b27;padding:32px 40px;border:1px solid rgba(255,255,255,0.07);border-top:none;border-bottom:none;">
      ...
      <p style="color:#7a8599;font-size:14px;margin:0 0 24px;">
        Hello <?php echo e($log->user?->name ?? $log->email); ?>, we detected a successful login to your KayXchange account.
      </p>
      ...
      <div style="background:#1e2535;border:1px solid rgba(255,255,255,0.07);border-radius:12px;padding:20px 24px;margin-bottom:24px;">
        <table width="100%" cellpadding="0" cellspacing="0">
          ...
          <tr>
            ...
            <td style="font-size:13px;color:#e4e8f0;font-weight:600;text-align:right;padding-bottom:10px;"><?php echo e($log->ip_address ?? 'Unknown'); ?></td>
          </tr>
          <tr>
...
<?php /**PATH C:\xampp\htdocs\kayxchangev2\resources\views/emails/login_success.blade.php ENDPATH**/ ?>