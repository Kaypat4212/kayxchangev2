...
<div class="col-xl-6 col-lg-7">
    ...
    <div class="kx-card">
        <div class="kx-card-hd">
            ...
            <div><h5>Trade Summary</h5><p>Selling <?php echo e($coin); ?> for Naira</p></div>
        </div>
        <div class="kx-card-bd">
            <div class="kx-trade-row">
                <div class="kx-trade-left">
                    <div class="kx-trade-icon" style="background:rgba(<?php echo e($coin=='BTC'?'247,147,26':($coin=='ETH'?'98,126,234':'38,161,123')); ?>,.15);color:<?php echo e($coinColor); ?>">
                        <?php echo e($coin=='BTC'?'₿':($coin=='ETH'?'Ξ':'₮')); ?>

                    </div>
                    <div>
                        <div class="kx-trade-label">You Send</div>
                        <div class="kx-trade-value"><?php echo e($coin); ?> · $<?php echo e(number_format($amountInUsd,2)); ?></div>
                    </div>
                </div>
                <div class="kx-trade-arrow"><i class="bi bi-arrow-right"></i></div>
                <div class="kx-trade-right">
                    <div class="kx-trade-label">You Receive</div>
                    <div class="kx-trade-value">₦<?php echo e(number_format($nairaAmount,2)); ?></div>
                </div>
            </div>
    ...
    <div class="kx-card">
        <div class="kx-card-hd">
            ...
            <div><h5>Wallet Address</h5><p>Send <strong style="color:#00cc00">$<?php echo e(number_format($amountInUsd,2)); ?> of <?php echo e($coin); ?></strong> to this address</p></div>
        </div>
        <div class="kx-card-bd">
            <div class="kx-wallet-box">
                <div class="kx-wallet-address" id="walletAddr"><?php echo e($walletAddress); ?></div>
            ...
            <div class="kx-barcode mt-3">
                <img src="<?php echo e($barcode); ?>" alt="<?php echo e($coin); ?> QR Code">
                <p class="mt-2" style="font-size:.78rem;color:var(--kx-muted)">Scan QR to send <?php echo e($coin); ?></p>
            </div>
            <?php endif; ?>
        </div>
    </div>
    ...
    <form method="POST" action="<?php echo e(route('sell.postStep2')); ?>" enctype="multipart/form-data" id="proofForm">
        <?php echo csrf_field(); ?>
        <div class="kx-card">
            <div class="kx-card-hd">
...
$message = $__bag->first($__errorArgs[0]); ?>
                <div class="mt-2 small" style="color:#ff6b6b"><i class="bi bi-exclamation-triangle-fill me-1"></i><?php echo e($message); ?></div>
                <?php unset($message);
...
<?php echo $__env->make('selllayout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\kayxchangev2\resources\views\sell\step2.blade.php ENDPATH**/ ?>