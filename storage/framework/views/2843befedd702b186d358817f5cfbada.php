...
<div style="display:none;max-height:0;overflow:hidden;mso-hide:all;font-size:1px;line-height:1px;color:#0d1117;">
  <?php echo e($preheader ?? $subject); ?> &nbsp;&zwnj;&nbsp;&zwnj;&nbsp;&zwnj;&nbsp;&zwnj;&nbsp;&zwnj;&nbsp;&zwnj;
</div>
...
<table width="600" cellpadding="0" cellspacing="0" role="presentation" style="max-width:600px;width:100%;">
  ...
  <tr>
    <td style="background:linear-gradient(135deg,#0a1628 0%,#0d1f1a 100%);border-radius:16px 16px 0 0;padding:28px 40px 22px;text-align:center;border:1px solid rgba(255,255,255,0.08);border-bottom:none;">
      ...
      <div style="font-size:22px;font-weight:800;color:#00cc00;letter-spacing:-0.5px;mso-hide:none;"><?php echo e(config('app.name')); ?></div>
  ...
  <tr>
    <td style="background:#161b27;padding:20px 40px 0;text-align:center;border-left:1px solid rgba(255,255,255,0.08);border-right:1px solid rgba(255,255,255,0.08);">
      <span style="display:inline-block;background:<?php echo e($badgeColor ?? '#00cc00'); ?>;color:<?php echo e(($badgeColor ?? '#00cc00') === '#ef4444' ? '#fff' : '#000'); ?>;font-weight:700;font-size:11px;padding:7px 20px;border-radius:50px;letter-spacing:1px;text-transform:uppercase;">
  ...
  <tr>
    <td style="background:#161b27;padding:32px 40px;border:1px solid rgba(255,255,255,0.08);border-top:none;border-bottom:none;">
      ...
      <?php if(isset($ctaUrl) && isset($ctaText)): ?>
      <!-- CTA button -->
      <div style="text-align:center;margin:32px 0 8px;">
        <!--[if mso]><v:roundrect xmlns:v="urn:schemas-microsoft-com:vml" href="<?php echo e($ctaUrl); ?>" style="height:48px;v-text-anchor:middle;width:220px;" arcsize="21%" stroke="f" fillcolor="#00cc00"><w:anchorlock/><center style="color:#000;font-family:sans-serif;font-size:15px;font-weight:700;"><?php echo e($ctaText); ?></center></v:roundrect><![endif]-->
...
<?php /**PATH C:\xampp\htdocs\kayxchangev2\resources\views/emails/trade_layout.blade.php ENDPATH**/ ?>