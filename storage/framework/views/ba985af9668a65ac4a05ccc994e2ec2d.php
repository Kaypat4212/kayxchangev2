...
<div class="container-fluid py-3 px-3 px-md-4">
    <div class="kx-page-header">
        <div>
            ...
            <small>Viewing details for <?php echo e($user->name); ?></small>
        </div>
        <div class="d-flex gap-2">
            <a href="<?php echo e(route('admin.users.edit', $user->id)); ?>" class="btn-kx-green"><i class="bi bi-pencil me-1"></i>Edit</a>
        ...
        <div class="col-md-4">
            <div class="kx-panel">
                ...
                <div style="padding:1.5rem;text-align:center">
                    ...
                    <div style="font-size:1.1rem;font-weight:700;color:#fff"><?php echo e($user->name); ?></div>
                    <div style="font-size:.8rem;color:var(--kx-muted);margin:.3rem 0 1rem"><?php echo e($user->email); ?></div>
                ...
                <div style="padding:1.25rem">
                    <div class="row g-3">
                        <div class="col-6">
                            ...
                            <div style="font-size:1.3rem;font-weight:700;color:var(--kx-green)">₦<?php echo e(number_format($user->balance ?? 0, 2)); ?></div>
                        </div>
                        <div class="col-6">
                            <div style="font-size:.72rem;color:var(--kx-muted);text-transform:uppercase">KYC Status</div>
                            <div class="mt-1">
                                <?php if($user->kyc_verified == 1): ?>
                                    <span class="kx-badge kx-badge-green"><i class="bi bi-patch-check-fill me-1"></i>Verified</span>
                                <?php elseif(isset($user->kyc_verified) && $user->kyc_verified === 0): ?>
                        ...
                        <div class="col-6">
                            ...
                            <div style="font-size:.85rem;color:var(--kx-text)"><?php echo e($user->created_at->format('d M Y, H:i')); ?></div>
                        </div>
                        <div class="col-6">
                            <div style="font-size:.72rem;color:var(--kx-muted);text-transform:uppercase">Last Updated</div>
                            <div style="font-size:.85rem;color:var(--kx-text)"><?php echo e($user->updated_at->diffForHumans()); ?></div>
                        </div>
                        <?php if($user->referral_code): ?>
                        <div class="col-6">
                            <div style="font-size:.72rem;color:var(--kx-muted);text-transform:uppercase">Referral Code</div>
                            <div style="font-size:.85rem;font-family:monospace;color:var(--kx-green)"><?php echo e($user->referral_code); ?></div>
                        </div>
                        <?php endif; ?>
                    </div>
                    <div class="mt-3 d-flex gap-2 flex-wrap">
                        <a href="<?php echo e(route('admin.users.backdoor', $user->id)); ?>"
                           ...
                           onclick="return confirm('Log in as <?php echo e(addslashes($user->name)); ?>?')">
...
<?php echo $__env->make('adminnavlayout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\kayxchangev2\resources\views\admin\users\show.blade.php ENDPATH**/ ?>