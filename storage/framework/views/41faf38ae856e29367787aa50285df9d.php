...
<div class="kx-sc-wrap">
    <div class="container-xl">
        ...
        <div class="kx-sc-alert"><i class="bi bi-check-circle-fill me-2"></i><?php echo e(session('success')); ?></div>
        <?php endif; ?>

        <form method="POST" action="<?php echo e(route('admin.site-content.update')); ?>">
            <?php echo csrf_field(); ?>
            ...
            <?php $__currentLoopData = $sections; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $group => $items): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <?php $g = $groupLabels[$group] ?? ['label' => ucfirst($group), 'icon' => 'bi-folder', 'cls' => '']; ?>
            <div class="kx-sc-card">
                <div class="kx-sc-group <?php echo e($g['cls']); ?>"><i class="bi <?php echo e($g['icon']); ?>"></i><?php echo e($g['label']); ?></div>
                <div class="row g-3">
                    <?php $__currentLoopData = $items; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <div class="<?php echo e(Str::contains($item->key, 'desc') || Str::contains($item->key, 'description') || Str::contains($item->key, 'subtitle') || Str::contains($item->key, 'tagline') ? 'col-12' : 'col-md-6'); ?>">
                        <div class="kx-sc-field">
                            <div class="kx-sc-label"><?php echo e($item->label); ?></div>
                            <?php if(Str::contains($item->key, ['desc', 'description', 'subtitle', 'tagline'])): ?>
                            <textarea name="content[<?php echo e($item->key); ?>]" class="kx-sc-input"><?php echo e(old('content.'.$item->key, $item->value)); ?></textarea>
                            <?php else: ?>
                            <input type="text" name="content[<?php echo e($item->key); ?>]" value="<?php echo e(old('content.'.$item->key, $item->value)); ?>" class="kx-sc-input">
                            <?php endif; ?>
                        </div>
                    </div>
            ...
            <div class="d-flex align-items-center gap-3 mt-2 flex-wrap">
                ...
                <a href="<?php echo e(url('/home')); ?>" target="_blank" class="btn btn-sm" style="border-radius:10px;padding:11px 20px;background:var(--kx-card2);border:1px solid var(--kx-border);color:var(--kx-text)">
                    <i class="bi bi-box-arrow-up-right me-1"></i>Preview Homepage
                </a>
                <a href="<?php echo e(url('/about')); ?>" target="_blank" class="btn btn-sm" style="border-radius:10px;padding:11px 20px;background:var(--kx-card2);border:1px solid var(--kx-border);color:var(--kx-text)">
...
<?php echo $__env->make('adminnavlayout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\kayxchangev2\resources\views\admin\site-content\index.blade.php ENDPATH**/ ?>