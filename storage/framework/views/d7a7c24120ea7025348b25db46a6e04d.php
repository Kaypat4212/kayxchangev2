<?php $__env->startPush('body-class', 'telegram-settings'); ?>
...
<div class="tg-wrap">
    ...
    <?php if(session('success')): ?>
        <div class="tg-alert success"><i class="fas fa-check-circle"></i><span><?php echo e(session('success')); ?></span></div>
    <?php endif; ?>
    <?php if(session('error')): ?>
        <div class="tg-alert error"><i class="fas fa-exclamation-circle"></i><span><?php echo e(session('error')); ?></span></div>
    <?php endif; ?>
    ...
    <div style="display:grid; grid-template-columns:1fr 1fr; gap:1.25rem;" class="tg-main-grid">
        ...
        <div>
            <div class="tg-card" style="height:100%;">
                ...
                <form method="POST" action="<?php echo e(route('settings.telegram.update')); ?>">
                    <?php echo csrf_field(); ?>
                    ...
                    <div style="margin-bottom:1.25rem;">
                        ...
                        <div class="tg-input-group">
                            ...
                            <input type="text"
                                   class="tg-input <?php $__errorArgs = ['telegram_username'];
...
unset($__errorArgs, $__bag); ?>"
                                   ...
                                   value="<?php echo e(old('telegram_username', Auth::user()->telegram_username)); ?>"
...
$message = $__bag->first($__errorArgs[0]); ?>
                            <p class="tg-hint error-text"><i class="fas fa-exclamation-circle me-1"></i><?php echo e($message); ?></p>
                        <?php unset($message);
if (isset($__messageOriginal)) { $message = $__messageOriginal; }
endif;
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="tg-switch-row">
                            ...
                            <label class="tg-switch">
                                <input type="checkbox" name="telegram_notifications" value="1"
                                       <?php echo e(Auth::user()->telegram_notifications ? 'checked' : ''); ?>>
                    ...
                    <div class="tg-action-row">
                        ...
                        <a href="<?php echo e(route('settings.index')); ?>" class="tg-btn-secondary">
    ...
    <div class="tg-card">
        ...
        <div class="tg-status-grid">
            <div class="tg-status-item">
                <div class="tg-status-icon">
                    <?php if(Auth::user()->telegram_username): ?>
                ...
                <div class="tg-status-val <?php echo e(Auth::user()->telegram_username ? 'ok' : 'off'); ?>">
                    <?php echo e(Auth::user()->telegram_username ? '@'.Auth::user()->telegram_username : 'Not set'); ?>

                </div>
            </div>
            <div class="tg-status-item">
                <div class="tg-status-icon">
                    <?php if(Auth::user()->telegram_notifications): ?>
                ...
                <div class="tg-status-val <?php echo e(Auth::user()->telegram_notifications ? 'ok' : 'warn'); ?>">
                    <?php echo e(Auth::user()->telegram_notifications ? 'Enabled' : 'Disabled'); ?>

                </div>
            </div>
            <div class="tg-status-item">
                <div class="tg-status-icon">
                    <?php if(Auth::user()->telegram_chat_id && Auth::user()->telegram_verified && Auth::user()->telegram_notifications): ?>
                        <i class="fas fa-rocket" style="color:#4ade80;"></i>
                    <?php elseif(Auth::user()->telegram_username && Auth::user()->telegram_notifications): ?>
                ...
                <div class="tg-status-val
                    <?php if(Auth::user()->telegram_chat_id && Auth::user()->telegram_verified && Auth::user()->telegram_notifications): ?> ok
                    <?php elseif(Auth::user()->telegram_username && Auth::user()->telegram_notifications): ?> warn
                    <?php else: ?> off <?php endif; ?>">
                    <?php if(Auth::user()->telegram_chat_id && Auth::user()->telegram_verified && Auth::user()->telegram_notifications): ?>
                        Fully connected
                    <?php elseif(Auth::user()->telegram_username && Auth::user()->telegram_notifications): ?>
                        Bot verification needed
                    <?php elseif(Auth::user()->telegram_username): ?>
        ...
        <?php elseif(Auth::user()->telegram_username && Auth::user()->telegram_notifications): ?>
            ...
            <div class="tg-alert" style="background:rgba(251,191,36,.07);border:1px solid rgba(251,191,36,.2);color:#fbbf24;margin:0;">
                ...
                <span><strong>Next step:</strong> Open <a href="https://t.me/TradewithkayxchangeBOT" target="_blank" style="color:#fbbf24;">@TradewithkayxchangeBOT</a> on Telegram and send your email <strong><?php echo e(Auth::user()->email); ?></strong> to complete verification.</span>
            </div>
        <?php endif; ?>
    </div>


<?php if(Auth::user()->telegram_chat_id && Auth::user()->telegram_verified): ?>
<div class="tg-card" style="margin-top:1.5rem;">
    ...
    <form method="POST" action="<?php echo e(route('settings.telegram.ai.update')); ?>">
        <?php echo csrf_field(); ?>
        <?php echo method_field('PUT'); ?>
        ...
        <div style="background:var(--kx-card2,#1e2535);border:1px solid rgba(255,255,255,0.07);
            ...
            <label class="tg-toggle">
                <input type="checkbox" name="telegram_ai_enabled" value="1"
                    <?php echo e(Auth::user()->telegram_ai_enabled ? 'checked' : ''); ?>>
...
<?php echo $__env->make('layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\kayxchangev2\resources\views\settings\telegram.blade.php ENDPATH**/ ?>