...
<head>
    ...
    <title>Admin — <?php echo e(config('app.name', 'KayXchange')); ?></title>
...
<body>
    ...
    <footer style="background:#1a1f2e;color:rgba(255,255,255,0.4);font-size:0.75rem;text-align:center;padding:14px;border-top:1px solid rgba(255,255,255,0.07);">
        © <?php echo e(date('Y')); ?> KayXchange Admin Panel &mdash; <a href="<?php echo e(url('/')); ?>" target="_blank" style="color:rgba(0,204,0,0.7);text-decoration:none">View Site</a>
    </footer>
...
</html><?php /**PATH C:\xampp\htdocs\kayxchangev2\resources\views/adminnavlayout.blade.php ENDPATH**/ ?>