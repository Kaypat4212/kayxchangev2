            ...
            <div class="install-body">
                ...
                <div class="requirement-section">
                    ...
                    <div class="requirement-item">
                        <div>
                            <strong>Required: <?php echo e($checks['php_version']['required']); ?> or higher</strong>
                            <br>
                            <small class="text-muted">Current: <?php echo e($checks['php_version']['current']); ?></small>
                        </div>
                        <div>
                ...
                <div class="requirement-section">
                    ...
                    <?php $__currentLoopData = $checks['extensions']['extensions']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $extension => $status): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <div class="requirement-item">
                        <div>
                            <strong><?php echo e($extension); ?></strong>
                        </div>
                        <div>
                            <?php if($status): ?>
                                <i class="fas fa-check-circle status-icon status-success"></i>
                ...
                <div class="requirement-section">
                    ...
                    <?php $__currentLoopData = $checks['permissions']['permissions']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $path => $permission): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <div class="requirement-item">
                        <div>
                            <strong><?php echo e($path); ?></strong>
                            <br>
                            <small class="text-muted">
                                Required: <?php echo e($permission['required']); ?> | 
                                Current: <?php echo e($permission['current']); ?>
                ...
                <div class="requirement-section">
                    ...
                    <div class="requirement-item">
                        <div>
                            ...
                            <br>
                            <small class="text-muted"><?php echo e($checks['node']['version']); ?></small>
                        </div>
                        <div>
                            <?php if($checks['node']['status']): ?>
                                <i class="fas fa-check-circle status-icon status-success"></i>
                            <?php else: ?>
                ...
                <div class="alert alert-danger">
                    ...
                    <ul class="mt-2 mb-0">
                        <?php if(!$checks['php_version']['status']): ?>
                            <li>Upgrade PHP to version <?php echo e($checks['php_version']['required']); ?> or higher</li>
                        <?php endif; ?>
                        <?php if(!$checks['extensions']['all_passed']): ?>
                            <li>Install missing PHP extensions</li>
                        <?php endif; ?>
                        <?php if(!$checks['permissions']['all_passed']): ?>
                ...
                <div class="d-flex justify-content-between mt-4">
                    <a href="<?php echo e(route('install.index')); ?>" class="btn btn-outline-secondary">
                    ...
                    <div>
                        ...
                        <a href="<?php echo e(route('install.database')); ?>" 
                           class="btn btn-install <?php echo e(!$canProceed ? 'disabled' : ''); ?>"
                           <?php if(!$canProceed): ?> onclick="return false;" <?php endif; ?>>
...
</html><?php /**PATH C:\xampp\htdocs\kayxchangev2\resources\views\install\requirements.blade.php ENDPATH**/ ?>