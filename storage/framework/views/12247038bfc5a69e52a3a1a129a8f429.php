...
<head>
    ...
    <title><?php echo e(config('app.name', 'KayXchange')); ?> — KYC Verification</title>
...
<body>
    ...
    <nav class="kx-bottom-nav" aria-label="Mobile navigation">
        <a href="<?php echo e(url('/dashboard')); ?>" class="kx-bnav-item <?php if(request()->is('dashboard')): ?> kx-bnav-active <?php endif; ?>"><i class="bi bi-grid-1x2-fill"></i><span>Home</span></a>
        <a href="<?php echo e(url('/rate')); ?>" class="kx-bnav-item <?php if(request()->is('rate')): ?> kx-bnav-active <?php endif; ?>"><i class="bi bi-graph-up-arrow"></i><span>Rates</span></a>
        <div class="kx-bnav-item kx-bnav-center">
            <a href="<?php echo e(url('/kyc')); ?>" class="kx-bnav-center-btn kx-bnav-active" title="KYC"><i class="bi bi-patch-check-fill"></i></a>
            <span class="kx-bnav-center-lbl">KYC</span>
        </div>
        <a href="<?php echo e(url('/sell')); ?>" class="kx-bnav-item <?php if(request()->is('sell*')): ?> kx-bnav-active <?php endif; ?>"><i class="bi bi-arrow-up-circle-fill"></i><span>Sell</span></a>
        <a href="<?php echo e(url('/settings')); ?>" class="kx-bnav-item <?php if(request()->is('settings*')): ?> kx-bnav-active <?php endif; ?>"><i class="bi bi-person-fill"></i><span>Account</span></a>
    </nav>
    <?php endif; ?>
    ...
    <?php echo $__env->make('components.kx-footer', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>

    <script src="https://cdn.jsdelivr.net/npm/bootstrap@5.3.3/dist/js/bootstrap.bundle.min.js"></script>
    <?php echo $__env->yieldPushContent('scripts'); ?>
</body>
</html><?php /**PATH C:\xampp\htdocs\kayxchangev2\resources\views\kyclayout.blade.php ENDPATH**/ ?>