  ...
  <div class="container">
    ...
    <div class="collapse navbar-collapse" id="kxNav">
      <ul class="navbar-nav me-auto mb-2 mb-lg-0 gap-1">
        ...
        <li class="nav-item">
          <a class="kx-nav-link <?php if(request()->is('dashboard')): ?> kx-active <?php endif; ?>" href="<?php echo e(url('/dashboard')); ?>">
            <i class="bi bi-grid-1x2-fill"></i>Dashboard
          </a>
        </li>
        <li class="nav-item">
          <a class="kx-nav-link <?php if(request()->is('deposits*')): ?> kx-active <?php endif; ?>" href="<?php echo e(url('/deposits/create')); ?>">
            <i class="bi bi-plus-circle-fill"></i>Deposit
          </a>
        </li>
        <li class="nav-item">
          <a class="kx-nav-link <?php if(request()->is('rate')): ?> kx-active <?php endif; ?>" href="<?php echo e(url('/rate')); ?>">
            <i class="bi bi-graph-up-arrow"></i>Rates
          </a>
        </li>
        <li class="nav-item">
          <a class="kx-nav-link <?php if(request()->is('rate-calculator')): ?> kx-active <?php endif; ?>" href="<?php echo e(url('/rate-calculator')); ?>">
            <i class="bi bi-calculator-fill"></i>Calculator
          </a>
        </li>
        <li class="nav-item">
          <a class="kx-nav-link <?php if(request()->is('buy*')): ?> kx-active <?php endif; ?>" href="<?php echo e(url('/buy')); ?>">
            <i class="bi bi-arrow-down-circle-fill"></i>Buy
          </a>
        </li>
        <li class="nav-item">
          <a class="kx-nav-link <?php if(request()->is('sell*')): ?> kx-active <?php endif; ?>" href="<?php echo e(url('/sell')); ?>">
            <i class="bi bi-arrow-up-circle-fill"></i>Sell
          </a>
        </li>
        <li class="nav-item">
          <a class="kx-nav-link <?php if(request()->is('settings*')): ?> kx-active <?php endif; ?>" href="<?php echo e(url('/settings')); ?>">
        ...
        <li class="nav-item">
          <a class="kx-nav-link" href="<?php echo e(route('admin.revert')); ?>">
        ...
        <?php else: ?>
        <li class="nav-item">
          <a class="kx-nav-link <?php if(request()->is('/')): ?> kx-active <?php endif; ?>" href="<?php echo e(url('/')); ?>">
        ...
        <li class="nav-item">
          <a class="kx-nav-link <?php if(request()->is('blog*')): ?> kx-active <?php endif; ?>" href="<?php echo e(url('/blog')); ?>">
            <i class="bi bi-newspaper"></i>Blog
          </a>
        </li>
        <li class="nav-item">
          <a class="kx-nav-link <?php if(request()->is('faqs*')): ?> kx-active <?php endif; ?>" href="<?php echo e(url('/faqs')); ?>">
            <i class="bi bi-question-circle-fill"></i>FAQs
          </a>
        </li>
        <li class="nav-item">
          <a class="kx-nav-link <?php if(request()->is('about*')): ?> kx-active <?php endif; ?>" href="<?php echo e(url('/about')); ?>">
      ...
      <div class="d-flex align-items-center kx-nav-actions gap-2">
        ...
        <?php else: ?>
        <a class="kx-btn-login" href="<?php echo e(route('login')); ?>">
          <i class="bi bi-box-arrow-in-right"></i>Login
        </a>
        <a class="kx-btn-register" href="<?php echo e(route('register')); ?>">
...
</script><?php /**PATH C:\xampp\htdocs\kayxchangev2\resources\views/components/navbar.blade.php ENDPATH**/ ?>