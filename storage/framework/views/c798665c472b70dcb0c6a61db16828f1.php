...
<div class="container my-4">
    <div class="d-flex justify-content-between align-items-center mb-4 animate-slide-in">
        ...
        <a href="<?php echo e(route('deposits.create')); ?>" class="btn btn-primary btn-make-deposit animate-pulse">
    ...
    <?php else: ?>
                    ...
                    <table class="table table-dark table-hover table-borderless mb-0">
                        ...
                        <tbody>
                            <?php $__currentLoopData = $deposits; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $deposit): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <tr class="animate-row" style="--row-index: <?php echo e($index); ?>">
                                    <td><?php echo e(number_format($deposit->amount, 2)); ?> NGN</td>
                                    <td>
                                        <span class="badge <?php echo e(($deposit->status === 'pending' ? 'bg-warning text-dark' : ($deposit->status === 'approved' ? 'bg-success' : ($deposit->status === 'rejected' ? 'bg-danger' : 'bg-secondary')))); ?>">
                                            <?php echo e(ucfirst($deposit->status)); ?>

                                        </span>
                                    </td>
                                    <td><?php echo e($deposit->transaction_ref); ?></td>
                                    <td><?php echo e($deposit->admin_note ?? 'N/A'); ?></td>
        ...
        <div class="mt-3 d-flex justify-content-center">
            <?php echo e($deposits->appends(request()->query())->links('pagination::bootstrap-5')); ?>
...
<?php echo $__env->make('layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\kayxchangev2\resources\views\deposits\index.blade.php ENDPATH**/ ?>