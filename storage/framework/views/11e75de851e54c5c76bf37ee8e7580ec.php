...
<head>
    ...
    <title><?php echo e(config('app.name', 'KayXchange')); ?> — Sell</title>
    ...
    *, *::before, *::after { box-sizing: border-box; }
    ...
    /* Fix .navbar conflict from old style.css if cached */
...
<body>
    ...
    <nav class="kx-bottom-nav" aria-label="Mobile navigation">
        ...
        <div class="kx-bnav-item kx-bnav-center">
            <a href="<?php echo e(Auth::user()->kyc_verified ? url('/buy') : url('/kyc')); ?>" class="kx-bnav-center-btn" title="Buy Crypto"><i class="bi bi-arrow-down-circle-fill"></i></a>
            <span class="kx-bnav-center-lbl">Buy</span>
        </div>
        <a href="<?php echo e(url('/sell')); ?>" class="kx-bnav-item kx-bnav-active"><i class="bi bi-arrow-up-circle-fill"></i><span>Sell</span></a>
...
</html><?php /**PATH C:\xampp\htdocs\kayxchangev2\resources\views\selllayout.blade.php ENDPATH**/ ?>