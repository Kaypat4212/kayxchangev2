    ...
    if (aiGenerateBtn) {
        aiGenerateBtn.addEventListener('click', async function () {
            try {
                ...
                var data = await aiPost('<?php echo e(route('admin.blog.ai.generate')); ?>', payload);
    ...
    if (aiOutlineBtn) {
        aiOutlineBtn.addEventListener('click', async function () {
            try {
                ...
                var data = await aiPost('<?php echo e(route('admin.blog.ai.outline')); ?>', { topic: topic });
    ...
    if (aiTitlesBtn) {
        aiTitlesBtn.addEventListener('click', async function () {
            try {
                ...
                var data = await aiPost('<?php echo e(route('admin.blog.ai.titles')); ?>', { topic: seed });
    ...
    if (aiImproveBtn) {
        aiImproveBtn.addEventListener('click', async function () {
            try {
                ...
                var data = await aiPost('<?php echo e(route('admin.blog.ai.improve')); ?>', {
                    text: selectedText,
    ...
    if (aiExcerptBtn) {
        aiExcerptBtn.addEventListener('click', async function () {
            try {
                ...
                var data = await aiPost('<?php echo e(route('admin.blog.ai.excerpt')); ?>', { content: html });
                if (ei) {
    ...
    if (aiSeoBtn) {
        aiSeoBtn.addEventListener('click', async function () {
            ...
            try {
                ...
                var data = await aiPost('<?php echo e(route('admin.blog.ai.seo-tags')); ?>', { content: html });
    ...
    if (aiSocialBtn) {
        aiSocialBtn.addEventListener('click', async function () {
            ...
            try {
                ...
                var data = await aiPost('<?php echo e(route('admin.blog.ai.social-caption')); ?>', {
    ...
    if (aiPlannerBtn) {
        aiPlannerBtn.addEventListener('click', async function () {
            try {
                ...
                var data = await aiPost('<?php echo e(route('admin.blog.ai.content-planner')); ?>', { context: ctx || undefined });
...
</script><?php /**PATH C:\xampp\htdocs\kayxchangev2\resources\views\admin\blog\_editor-scripts.blade.php ENDPATH**/ ?>