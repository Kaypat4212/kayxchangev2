<?php $__env->startSection('title', 'Withdrawal Submitted'); ?>
...
<div class="ws-wrap">
    ...
    <div class="ws-hero-card">
        ...
        <div class="ws-status-pill <?php echo e($statusClass); ?>">
    ...
    <div class="ws-details-card">
        ...
        <div class="ws-row">
            ...
            <span class="ws-row-val amount">₦<?php echo e(number_format($withdrawal->amount, 2)); ?></span>
        </div>
        <div class="ws-row">
            <span class="ws-row-key">Reference</span>
            <span class="ws-row-val ref"><?php echo e($withdrawal->reference); ?></span>
        </div>
        <div class="ws-row">
        ...
        <div class="ws-row">
            ...
            <span class="ws-row-val"><?php echo e($withdrawal->created_at->format('d M Y, H:i')); ?></span>
        </div>
    </div>
    ...
    <div class="ws-details-card">
        ...
        <div class="ws-row">
            ...
            <span class="ws-row-val"><?php echo e($bankDetails['bank_name'] ?? 'N/A'); ?></span>
        </div>
        <div class="ws-row">
            <span class="ws-row-key">Account Number</span>
            <span class="ws-row-val"><?php echo e($bankDetails['account_number'] ?? 'N/A'); ?></span>
        </div>
        <div class="ws-row">
            <span class="ws-row-key">Account Name</span>
            <span class="ws-row-val"><?php echo e($bankDetails['account_name'] ?? 'N/A'); ?></span>
        </div>
    </div>
    ...
    <a href="<?php echo e(route('dashboard')); ?>" class="ws-btn-primary">
        <i class="bi bi-grid-1x2-fill me-2"></i>Back to Dashboard
    </a>
    <a href="<?php echo e(route('withdraw')); ?>" class="ws-btn-sec">
...
<?php echo $__env->make('layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\kayxchangev2\resources\views\withdraw\success.blade.php ENDPATH**/ ?>