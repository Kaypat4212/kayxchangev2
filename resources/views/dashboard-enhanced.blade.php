...
<div class="dashboard-container">
    ...
    <div class="welcome-section animate-fade-in">
        <div class="row align-items-center">
            ...
            <div class="col-md-4 text-md-end mt-3 mt-md-0">
                <div class="balance-display">₦{{ number_format(Auth::user()->balance, 2) }}</div>
    ...
    <div class="stats-grid animate-slide-up section-spacing">
        <div class="stat-card">
            ...
            <div class="stat-value" id="totalBalance">₦{{ number_format(Auth::user()->balance, 2) }}</div>
    ...
    <div class="action-buttons animate-slide-up section-spacing">
        <a href="{{ Auth::user()->kyc_verified ? route('buy') : route('kyc.form') }}" class="action-btn">
            <i class="fas fa-shopping-cart"></i>
            Buy Crypto
        </a>
        <a href="{{ route('sell.form') }}" class="action-btn outline">
            <i class="fas fa-coins"></i>
            Sell Crypto
        </a>
        <a href="{{ route('withdraw') }}" class="action-btn">
            <i class="fas fa-money-bill-wave"></i>
            Withdraw
        </a>
        <a href="{{ route('deposits.index') }}" class="action-btn outline">
            <i class="fas fa-plus-circle"></i>
            Deposit
        </a>
        <a href="{{ route('transactions.history') }}" class="action-btn">
            <i class="fas fa-history"></i>
            Transactions
        </a>
        <a href="{{ route('referrals') }}" class="action-btn outline">
    ...
    <div class="dashboard-card animate-slide-up section-spacing">
        <div class="d-flex justify-content-between align-items-center mb-4">
            ...
            <a href="{{ route('transactions.history') }}" class="btn btn-outline-primary btn-sm">View All</a>
        </div>
        <div class="table-container">
            <table class="data-table">
                <thead>
    ...
    <div class="dashboard-card animate-slide-up section-spacing" style="border: 1px solid var(--warning); background: rgba(255, 193, 7, 0.1);">
        <div class="d-flex align-items-center gap-3">
            ...
            <a href="{{ route('kyc.form') }}" class="btn btn-warning">
...
<div class="quick-actions d-md-none">
    <button class="quick-action-btn" onclick="location.href='{{ route('buy') }}'" title="Buy Crypto">
        <i class="fas fa-plus"></i>
    </button>
    <button class="quick-action-btn" onclick="location.href='{{ route('sell.form') }}'" title="Sell Crypto">
...
<script>
        ...
        portfolioChart = new Chart(ctx, {
            ...
            data: {
                ...
                datasets: [{
                    ...
                    data: [50000, 55000, 52000, 58000, 65000, {{ Auth::user()->balance }}],
                    borderColor: '#00c851',
    ...
    function updateChart(period) {
        ...
        const sampleData = {
            '7d': [48000, 49000, 51000, 52000, 50000, 53000, {{ Auth::user()->balance }}],
            '30d': [45000, 48000, 52000, 55000, 58000, 60000, {{ Auth::user()->balance }}],
            '90d': [40000, 45000, 50000, 55000, 58000, 62000, {{ Auth::user()->balance }}]
        };
