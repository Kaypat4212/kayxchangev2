...
<head>
    ...
    <title>{{ config('app.name', 'KayXchange') }} — KYC Verification</title>
...
<body>
    ...
    <nav class="kx-bottom-nav" aria-label="Mobile navigation">
        ...
        <div class="kx-bnav-item kx-bnav-center">
            <a href="{{ url('/kyc') }}" class="kx-bnav-center-btn kx-bnav-active" title="KYC"><i class="bi bi-patch-check-fill"></i></a>
