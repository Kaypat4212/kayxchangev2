  ...
  <main class="lx-main">
    <div class="lx-wrap">
      ...
      <div class="lx-right">
        ...
        <form method="POST" action="{{ route('register') }}" id="lx-reg-form" novalidate>
          @csrf

          <div class="mb-3">
            <label for="name" class="lx-label">Full name</label>
            <input id="name" name="name" type="text"
              class="lx-field @error('name') is-invalid @enderror"
              value="{{ old('name') }}"
          ...
          <div class="mb-4">
            ...
            <input id="referral_code" name="referral_code" type="text"
              class="lx-field @error('referral_code') is-invalid @enderror"
