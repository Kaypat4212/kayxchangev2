...
<div class="kx-footer-inner container-xl">
    <div class="kx-footer-grid">
        ...
        <div class="kx-footer-brand-col">
            <a href="{{ url('/') }}" class="kx-footer-brand">
        ...
        <div class="kx-footer-col">
            ...
            <ul class="kx-footer-links">
                @auth
                <li><a href="{{ url('/dashboard') }}"><i class="bi bi-grid-1x2-fill me-2"></i>Dashboard</a></li>
                <li><a href="{{ url('/rate') }}"><i class="bi bi-graph-up-arrow me-2"></i>Rates</a></li>
                <li><a href="{{ Auth::user()->kyc_verified ? url('/buy') : url('/kyc') }}"><i class="bi bi-arrow-down-circle-fill me-2"></i>Buy Crypto</a></li>
                <li><a href="{{ url('/sell') }}"><i class="bi bi-arrow-up-circle-fill me-2"></i>Sell Crypto</a></li>
                <li><a href="{{ url('/transactions/history') }}"><i class="bi bi-clock-history me-2"></i>Transactions</a></li>
                @else
                ...
                <li><a href="{{ route('register') }}"><i class="bi bi-person-plus-fill me-2"></i>Register</a></li>
                @endauth
            </ul>
        </div>
        ...
        <div class="kx-footer-col">
            ...
            <ul class="kx-footer-links">
                @auth
                <li><a href="{{ url('/settings') }}"><i class="bi bi-gear-fill me-2"></i>Settings</a></li>
                <li><a href="{{ url('/referrals') }}"><i class="bi bi-people-fill me-2"></i>Referrals</a></li>
                <li><a href="{{ url('/deposits/create') }}"><i class="bi bi-wallet-fill me-2"></i>Deposit</a></li>
                <li><a href="{{ url('/withdraw') }}"><i class="bi bi-cash-stack me-2"></i>Withdraw</a></li>
                @else
                <li><a href="{{ route('login') }}"><i class="bi bi-person-fill me-2"></i>My Account</a></li>
                @endauth
            </ul>
        </div>
    ...
    <div class="kx-footer-bottom">
        <span>© {{ date('Y') }} KayXchange. All rights reserved.</span>
