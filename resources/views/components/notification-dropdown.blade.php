...
document.addEventListener('DOMContentLoaded', function() {
    const notificationsApiUrl = @json(route('notifications.api'));
    const markAllReadUrl = @json(route('notifications.mark-all-read'));
    const notificationBaseUrl = @json(url('/notifications'));
