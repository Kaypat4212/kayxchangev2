        ...
        <div class="col-12 col-lg-4">
            ...
            <div class="kx-card kx-sup-info mt-3">
                ...
                <button class="kx-topic-btn"
                    onclick="prefillTopic('{{ $topic['text'] }}')">
                    <i class="bi {{ $topic['icon'] }} me-2" style="color:#00cc00"></i>{{ $topic['text'] }}
                </button>
                @endforeach
            </div>
        </div>
...
(function () {
    ...
    const historyUrl = @json(route('chat.history'));
    ...
    function buildBubble(msg) {
        const isUser = {{ Auth::id() }} === msg.sender_id && msg.receiver_id === null || {{ Auth::id() }} === msg.sender_id;
