...
<head>
    ...
    <title>{{ config('app.name', 'KayXchange') }} — Sell</title>
    ...
    *, *::before, *::after { box-sizing: border-box; }
    ...
    body.light-mode .kx-card-hd h5,
    body.light-mode .kx-coin-btn .coin-name,
    body.light-mode .kx-conv-value,
    body.light-mode .sell-hero h1 { color:#0a1a0a; }
    ...
    body.light-mode .kx-net-btn:hover { color:#0a1a0a; }
...
<body>
    ...
    <nav class="kx-bottom-nav" aria-label="Mobile navigation">
        ...
        <a href="{{ url('/sell') }}" class="kx-bnav-item kx-bnav-active"><i class="bi bi-arrow-up-circle-fill"></i><span>Sell</span></a>
