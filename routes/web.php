...
// Edit rate routes
Route::get('/admin/set-rates', [AdminController::class, 'setRates'])->name('admin.set-rates');
Route::get('/admin/edit-rate/{id}', [AdminController::class, 'editRate'])->name('admin.edit-rate');
Route::post('/admin/update-rate/{id}', [AdminController::class, 'updateRate'])->name('admin.update-rate');
...
// Sell Trade Actions
Route::get('/sell', [SellController::class, 'step1'])->name('sell.form');
Route::post('/sell', [SellController::class, 'submitSellForm'])->name('sell');
